...
binary128-ordered breakpoint sweep find the exact line minimum. Implement
this report-only baseline next; it cannot update state or select a full QP
solver.
