...
5. Apply the unchanged `gamma_factor` to `16*row_degree+66`. Require every
   local upper no greater than current and at least one strict improvement.
