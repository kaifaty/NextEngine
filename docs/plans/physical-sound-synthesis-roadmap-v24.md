...
| Status | `ADOPTED / V23_IMPLEMENTATION_REJECT / QUALITY_UNOBSERVED / D0_REPEAT_EXACT_PASS / T0_X0_PROTOCOLS_FROZEN / T0_IMPLEMENTATION_NEXT / DATA_FIRST_ML / INTERNET_ONLY_REAL_EVIDENCE / AUTOMATED_VALIDATOR_REQUIRED / CLIP_FALLBACK / RUNTIME_NOT_AUTHORIZED` |
...
| T0 | Synthetic teacher corpus | `PROTOCOL_FROZEN / IMPLEMENTATION_NEXT / VALUES_UNOPENED` | [T0 protocol](../development/physical-sound-v24-t0-analytic-teacher-protocol-2026-09-01.md) freezes twelve analytic plate/beam objects, exact modal/gain binaries, contacts, remesh twins, causal controls and full-entry A/B before generation. |
| X0 | Exact real-object pilot | `PROTOCOL_FROZEN / DISCLOSED_VALUES_ONLY / IMPLEMENTATION_BLOCKED_BY_T0_COMMIT` | [X0 protocol](../development/physical-sound-v24-x0-blue-bowl-pilot-protocol-2026-09-01.md) freezes four already disclosed REALIMPACT Blue Bowl contacts plus three ObjectFolder recordings; missing axes stay absent and contact `4` stays sealed. |
