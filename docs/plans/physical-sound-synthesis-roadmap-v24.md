...
| Status | `ADOPTED / V23_IMPLEMENTATION_REJECT / QUALITY_UNOBSERVED / D0_T0_REPEAT_EXACT_PASS / X0_PROTOCOL_FROZEN / X0_IMPLEMENTATION_NEXT / DATA_FIRST_ML / INTERNET_ONLY_REAL_EVIDENCE / AUTOMATED_VALIDATOR_REQUIRED / CLIP_FALLBACK / RUNTIME_NOT_AUTHORIZED` |
...
| X0 | Exact real-object pilot | `PROTOCOL_FROZEN / DISCLOSED_VALUES_ONLY / IMPLEMENTATION_NEXT` | [X0 protocol](../development/physical-sound-v24-x0-blue-bowl-pilot-protocol-2026-09-01.md) freezes four already disclosed REALIMPACT Blue Bowl contacts plus three ObjectFolder recordings; missing axes stay absent and contact `4` stays sealed. |
