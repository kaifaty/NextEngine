...
| Актуальное evidence | [PS-2 REALIMPACT metal batch payload/candidate protocol](../development/physical-sound-realimpact-metal-batch-protocol-ps2-2026-08-28.md) |
...
| Последний пакет | [REALIMPACT metal batch payload/candidate protocol](../development/physical-sound-realimpact-metal-batch-protocol-ps2-2026-08-28.md) |
...
shadow order. Next implement a repeated zero-access execution preflight. See
