...
| Поле | Значение |
| --- | --- |
| Статус | `ACTIVE_R&D / PS-2_PITCHER_COMBINED_PROTOCOL_REJECTED / OBSERVATION_ADMISSION_FAILED / CERAMIC_CUP_DISCOVERY_VERIFIED / OBSERVATION_PROTOCOL_FROZEN / THREE_REQUESTS_AUTHORIZED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / REAL_3D_FIELD_OPEN / EIGHT_EXACT_CLAIMS_OPEN / AUTOMATIC_PASS_DISABLED / PRODUCTION_P1_BLOCKED` |
| Архитектурная граница | [SPEC-45](../architecture/45-physical-sound-synthesis-and-acoustic-presentation.md), `Proposed` |
| Актуальное evidence | [PS-2 REALIMPACT Ceramic Cup observation protocol](../development/physical-sound-realimpact-ceramic-cup-observation-preflight-ps2-2026-08-28.md) |
...
| Последний пакет | [Ceramic Cup observation protocol](../development/physical-sound-realimpact-ceramic-cup-observation-preflight-ps2-2026-08-28.md) |
...
| PS-2. Corpus and risk closure | `IN_PROGRESS / PITCHER_COMBINED_PROTOCOL_REJECTED / OBSERVATION_ADMISSION_FAILED / CERAMIC_CUP_DISCOVERY_VERIFIED / OBSERVATION_PROTOCOL_FROZEN / THREE_REQUESTS_AUTHORIZED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / REAL_3D_FIELD_OPEN / EIGHT_EXACT_CLAIMS_OPEN` | L | Parent `8bd5323c…1aea` rejects the combined protocol; audit `68c79a37…5a57` exposes observation failure. Discovery `2b183dae…782b` / `cd68ba79…1b0b` now supports manifest `71123b21…cae5`: execute its two metadata ranges and one fixed prefix once, then run unchanged V2 admission before physics. Do not open Planter. |
...
| 4 | Controlled pilot, `E1` bundle import, internet registry/cache, eight-project E3 normalization, explicit roles, five typed E2 rows, exact-domain/source gates, transfer calibration and spatial discriminators — `PITCHER_COMBINED_PROTOCOL_REJECTED / OBSERVATION_ADMISSION_FAILED / CERAMIC_CUP_DISCOVERY_VERIFIED / OBSERVATION_PROTOCOL_FROZEN / THREE_REQUESTS_AUTHORIZED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / REAL_3D_FIELD_OPEN / EIGHT_EXACT_CLAIMS_OPEN`; next execute and repeat Ceramic Cup observation admission before physics | PS-2 domain-axis readiness |
