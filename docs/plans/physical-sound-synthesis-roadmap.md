...
| Поле | Значение |
| --- | --- |
| Статус | `ACTIVE_R&D / PS-2_PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_METHOD_DEVELOPMENT_CLOSED / SALIENCE_SELECTOR_SYNTHETIC_CONTROL_SUPPORTED / SCALE_INVARIANCE_SUPPORTED / IRON_SKILLET_DISCOVERY_VERIFIED / ONE_IMPACT_OBSERVATION_PROTOCOL_FROZEN / EXECUTION_PREFLIGHT_SUPPORTED / FOUR_REQUEST_ACQUISITION_AUTHORIZED / OBSERVATION_NOT_OPENED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN / AUTOMATIC_PASS_DISABLED / PRODUCTION_P1_BLOCKED` |
| Архитектурная граница | [SPEC-45](../architecture/45-physical-sound-synthesis-and-acoustic-presentation.md), `Proposed` |
| Актуальное evidence | [PS-2 Iron Skillet execution preflight](../development/physical-sound-realimpact-iron-skillet-execution-preflight-ps2-2026-08-28.md) |
...
| Последний пакет | [Iron Skillet execution preflight](../development/physical-sound-realimpact-iron-skillet-execution-preflight-ps2-2026-08-28.md) |
...
| PS-2. Corpus and risk closure | `IN_PROGRESS / PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_METHOD_DEVELOPMENT_CLOSED / SALIENCE_SELECTOR_SYNTHETIC_CONTROL_SUPPORTED / SCALE_INVARIANCE_SUPPORTED / IRON_SKILLET_DISCOVERY_VERIFIED / ONE_IMPACT_OBSERVATION_PROTOCOL_FROZEN / EXECUTION_PREFLIGHT_SUPPORTED / FOUR_REQUEST_ACQUISITION_AUTHORIZED / OBSERVATION_NOT_OPENED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN` | L | Repeated zero-access `b9927f17…672b` binds the complete four-stage runner. After commit execute exactly four requests once, decode once and analyze twice; failure is immutable. |
