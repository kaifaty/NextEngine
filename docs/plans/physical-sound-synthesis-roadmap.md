...
| Поле | Значение |
| --- | --- |
| Статус | `ACTIVE_R&D / PS-2_PITCHER_COMBINED_PROTOCOL_REJECTED / ADAPTIVE_DECAY_SYNTHETIC_CONTROL_SUPPORTED / CERAMIC_ADAPTIVE_COUNTERFACTUAL_FROZEN / TWO_READ_ONLY_ANALYSES_AUTHORIZED / INDEPENDENT_VALIDATION_REQUIRED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN / AUTOMATIC_PASS_DISABLED / PRODUCTION_P1_BLOCKED` |
| Архитектурная граница | [SPEC-45](../architecture/45-physical-sound-synthesis-and-acoustic-presentation.md), `Proposed` |
| Актуальное evidence | [PS-2 Ceramic Cup adaptive counterfactual preflight](../development/physical-sound-ceramic-cup-adaptive-counterfactual-preflight-ps2-2026-08-28.md) |
...
| Последний пакет | [Ceramic Cup adaptive counterfactual preflight](../development/physical-sound-ceramic-cup-adaptive-counterfactual-preflight-ps2-2026-08-28.md) |
...
| PS-2. Corpus and risk closure | `IN_PROGRESS / PITCHER_COMBINED_PROTOCOL_REJECTED / ADAPTIVE_DECAY_SYNTHETIC_CONTROL_SUPPORTED / CERAMIC_ADAPTIVE_COUNTERFACTUAL_FROZEN / TWO_READ_ONLY_ANALYSES_AUTHORIZED / INDEPENDENT_VALIDATION_REQUIRED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN` | L | Manifest `48001fb7…ff9a` and preflight `4358d4da…220f` freeze the same Ceramic rows, adaptive method, fixed comparator and seven checks. Execute twice after commit. |
...
| 4 | Controlled pilot, `E1` bundle import, internet registry/cache, eight-project E3 normalization, explicit roles, five typed E2 rows, exact-domain/source gates, transfer calibration and spatial discriminators — `PITCHER_COMBINED_PROTOCOL_REJECTED / ADAPTIVE_DECAY_SYNTHETIC_CONTROL_SUPPORTED / CERAMIC_ADAPTIVE_COUNTERFACTUAL_FROZEN / TWO_READ_ONLY_ANALYSES_AUTHORIZED / INDEPENDENT_VALIDATION_REQUIRED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN`; next execute Ceramic adaptive counterfactual twice, not physics | PS-2 domain-axis readiness |
