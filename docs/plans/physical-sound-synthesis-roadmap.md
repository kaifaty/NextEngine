...
flowchart LR
    ...
    PS1 --> PS2["PS-2 Corpus and risk policy<br/>3 E3 PROJECT GROUPS / GLASS 5/16 / 2 E2 OBJECTS"]
...
| PS-2. Corpus and risk closure | `IN_PROGRESS / THREE_E3_PROJECT_GROUPS / GLASS_5_OF_16 / TWO_REALIMPACT_E2_OBJECTS / E3_EXPANSION_NEXT` | L | Power policy, `E1` import, bounded source/cache/archive handling and claim-scoped `E1`–`E4` accounting are executable. REALIMPACT contributes two typed fallback E2 object rows; the second is reproduced by a 1.61 MB bounded-range import from the 2.31 GB GreenGoblet archive. AV-MSF + YCB + Heller validate 13 objects/33 E3 recordings in three project groups; Glass remains `5/16` because E2 does not create validator groups. The next package resumes stable-object E3 expansion; no local capture is required. |
...
| 4 | Controlled pilot, `E1` bundle import, internet registry/cache, AV-MSF/YCB/Heller E3 normalization, two REALIMPACT E2 object rows and bounded Greatest Hits rejection — `THREE_E3_PROJECT_GROUPS / GLASS_5_OF_16 / TWO_E2_OBJECTS`; GreenGoblet range import is complete, next continue stable-object E3 expansion and complementary E2/E1 evidence | PS-2 remaining evidence expansion |
