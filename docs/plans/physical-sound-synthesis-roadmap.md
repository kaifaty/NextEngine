...
| Поле | Значение |
| --- | --- |
| Статус | `ACTIVE_R&D / PS-2_PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_ADAPTIVE_COUNTERFACTUAL_REJECTED / CERAMIC_METHOD_DEVELOPMENT_CLOSED / CURRENT_PEAK_SELECTOR_UNSUPPORTED / SALIENCE_SELECTOR_SYNTHETIC_CONTROL_NEXT / INDEPENDENT_OBJECT_REQUIRED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN / AUTOMATIC_PASS_DISABLED / PRODUCTION_P1_BLOCKED` |
| Архитектурная граница | [SPEC-45](../architecture/45-physical-sound-synthesis-and-acoustic-presentation.md), `Proposed` |
| Актуальное evidence | [PS-2 Ceramic Cup adaptive counterfactual result](../development/physical-sound-ceramic-cup-adaptive-counterfactual-result-ps2-2026-08-28.md) |
...
| Последний пакет | [Ceramic Cup adaptive counterfactual result](../development/physical-sound-ceramic-cup-adaptive-counterfactual-result-ps2-2026-08-28.md) |
...
| PS-2. Corpus and risk closure | `IN_PROGRESS / PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_ADAPTIVE_COUNTERFACTUAL_REJECTED / CERAMIC_METHOD_DEVELOPMENT_CLOSED / CURRENT_PEAK_SELECTOR_UNSUPPORTED / SALIENCE_SELECTOR_SYNTHETIC_CONTROL_NEXT / INDEPENDENT_OBJECT_REQUIRED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN` | L | Repeated report `2ec3b03e…d6b7` has only `6/16` valid fits and rejects the input/estimator pair. Next synthetic ±`10%` salience-selector control, then an unopened object. |
...
| 4 | Controlled pilot, `E1` bundle import, internet registry/cache, eight-project E3 normalization, explicit roles, five typed E2 rows, exact-domain/source gates, transfer calibration and spatial discriminators — `PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_ADAPTIVE_COUNTERFACTUAL_REJECTED / CERAMIC_METHOD_DEVELOPMENT_CLOSED / CURRENT_PEAK_SELECTOR_UNSUPPORTED / SALIENCE_SELECTOR_SYNTHETIC_CONTROL_NEXT / INDEPENDENT_OBJECT_REQUIRED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN`; next synthetic salience selector, then unopened object, not physics | PS-2 domain-axis readiness |
