...
| Поле | Значение |
| --- | --- |
| Статус | `ACTIVE_R&D / PS-2_PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_CUP_SHARED_DECAY_MISMATCH_SUPPORTED / MULTIOUTPUT_SYNTHETIC_CONTROL_SUPPORTED / CERAMIC_COUNTERFACTUAL_FREEZE_NEXT / REAL_ANALYSIS_BLOCKED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / REAL_3D_FIELD_OPEN / EIGHT_EXACT_CLAIMS_OPEN / AUTOMATIC_PASS_DISABLED / PRODUCTION_P1_BLOCKED` |
| Архитектурная граница | [SPEC-45](../architecture/45-physical-sound-synthesis-and-acoustic-presentation.md), `Proposed` |
| Актуальное evidence | [PS-2 multi-output decay control result](../development/physical-sound-multioutput-decay-control-result-ps2-2026-08-28.md) |
...
| Последний пакет | [Multi-output decay control result](../development/physical-sound-multioutput-decay-control-result-ps2-2026-08-28.md) |
...
| PS-2. Corpus and risk closure | `IN_PROGRESS / PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_CUP_SHARED_DECAY_MISMATCH_SUPPORTED / MULTIOUTPUT_SYNTHETIC_CONTROL_SUPPORTED / CERAMIC_COUNTERFACTUAL_FREEZE_NEXT / REAL_ANALYSIS_BLOCKED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / REAL_3D_FIELD_OPEN / EIGHT_EXACT_CLAIMS_OPEN` | L | Two reports `a099f50d…e8bea` repeat a full synthetic pass: spatial/node decay fractions `1.0/0.0`, known-decay error `0.35979 dB/s`. Freeze the existing Ceramic fixed-row counterfactual before real reuse. |
...
| 4 | Controlled pilot, `E1` bundle import, internet registry/cache, eight-project E3 normalization, explicit roles, five typed E2 rows, exact-domain/source gates, transfer calibration and spatial discriminators — `PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_CUP_SHARED_DECAY_MISMATCH_SUPPORTED / MULTIOUTPUT_SYNTHETIC_CONTROL_SUPPORTED / CERAMIC_COUNTERFACTUAL_FREEZE_NEXT / REAL_ANALYSIS_BLOCKED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / REAL_3D_FIELD_OPEN / EIGHT_EXACT_CLAIMS_OPEN`; next freeze the existing Ceramic fixed-row multi-output counterfactual, not physics | PS-2 domain-axis readiness |
