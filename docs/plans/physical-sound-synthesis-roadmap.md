...
| Актуальное evidence | [PS-2 Iron Skillet observation result](../development/physical-sound-realimpact-iron-skillet-observation-result-ps2-2026-08-28.md) |
...
| Последний пакет | [Iron Skillet observation result](../development/physical-sound-realimpact-iron-skillet-observation-result-ps2-2026-08-28.md) |
...
| PS-2. Corpus and risk closure | `IN_PROGRESS / PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_METHOD_DEVELOPMENT_CLOSED / IRON_SKILLET_METHOD_TRANSFER_REJECTED / SALIENCE_SELECTOR_REAL_TRANSFER_REJECTED / SYNTHETIC_CONTROL_RETAINED / CURRENT_TOP16_DIAGNOSTIC_STRONGER / BOUNDED_METHOD_RESEARCH_REQUIRED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN` | L | Repeated `a9c4ae36…206d` fails persistence `0.35294` and adaptive-valid fraction `0.50`, while diagnostic top-16 is `0.9375/0.9375`. Next bounded existing-block diagnostics and primary-source method research, not tuning or another object. |
