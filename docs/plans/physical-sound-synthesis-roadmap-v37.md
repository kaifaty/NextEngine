...
| Статус | `ACTIVE / R0_N0_NR_RESEARCH_COMPLETE / QSO_V0_SELECTED / A0_F0_C0_REPEAT_EXACT_PASS / X0_NEXT / V36_CLOSED / H0_UNOPENED / ML_FIRST / AUTOMATIC_VALIDATION / AUTHORED_FALLBACK` |
...
flowchart TD
    ...
    NRA --> NRF["NR F0-C0 complete; X0-E0 preflight: next"]
...
| NR | Successor representation research | [`QSO_V0_SELECTED / A0_F0_C0_REPEAT_EXACT_PASS / X0_NEXT`](../development/physical-sound-v37-c0-query-surface-structural-cost-result-2026-09-03.md) | A0/F0 freeze the typed boundary and fresh science; C0 proves all 15,120 query rows, 9,720 fields, remesh/permutation/topology/ablation reachability and nine full cost paths repeat-exactly inside `300 s / 1 GiB` with zero scientific target/truth/official access. X0 complete-owner terminal conformance is next. |
...
7. **V37.6 — next:** X0 связывает complete owner и atomic terminal publisher; E0 затем
