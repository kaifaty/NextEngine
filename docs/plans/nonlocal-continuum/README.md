...
| NR2 | [GPU optimization discriminators](02-gpu-optimization-discriminators.md) and [O1 pointer-swap contract](04-nr2-o1-pointer-swap.md) | `UNBLOCKED`: O1 starts from the correctness-valid gather successor; RC1 timings are observations, not retained NR2 credit | report only |
