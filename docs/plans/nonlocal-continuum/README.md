...
| NR2 | [GPU optimization discriminators](02-gpu-optimization-discriminators.md), [O1 pointer-swap contract](04-nr2-o1-pointer-swap.md) and [O1 evidence](../../development/nonlocal-continuum-nr2-o1-evidence-2026-08-20.md) | O1 retains exact pointer-swap handoff with unchanged memory and `1.1091x` HN-3 adjacent total-p95 geometric speedup; O2 is next | report only |
