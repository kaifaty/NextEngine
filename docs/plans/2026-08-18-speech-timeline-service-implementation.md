...
| Follow-up | [Phase 2: LLM and TTS](2026-08-18-conversation-service-phase-2.md) after Phase 1 residency/latency gates; engine neural integration is Phase 3 and FunctionGemma is Phase 4 |
