...
scale-`0.125` interval. R89 restores ratio `0.517` and improves exact merit to
  ...
  exhausted. R102 next builds a hash-closed report-only native-rollout evaluator
  before any sequence-knot search, solver change or all-17.
