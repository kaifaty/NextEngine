...
new slack policy or limit is introduced. Only `cmu139` PASS permits an
unchanged clean all-three/all-17 offline rerun; only that PASS permits fresh
all-17. Exact rejection instead triggers a new research/modeling cycle.
