...
| Status | `ADOPTED / R0_COMPLETE / P0A_FROZEN / C0_REPEAT_EXACT_PASS / P0B_FROZEN / F0_IMPLEMENTATION_PENDING / I0_NOT_RUN / SOURCE_GROWTH_PARALLEL / ADMISSION_BLOCKED / RUNTIME_NOT_AUTHORIZED` |
...
| F0 | Residual harmonic field operator | `NOT_RUN / IMPLEMENTATION_PENDING` | The fixed learned prior plus intrinsic harmonic residual beats raw harmonic, prior-only and Euclidean/geodesic residual controls on every required field/topology stratum with C0 fallback and exact repeat. |
