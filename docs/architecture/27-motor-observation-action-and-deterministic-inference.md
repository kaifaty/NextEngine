...
from fatigue, damage, healing, Motor state and replay authority. Actual muscle
activation requires the separately gated muscle-actuated profile described by
SPEC-36.
