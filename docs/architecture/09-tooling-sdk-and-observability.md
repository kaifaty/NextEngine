...
| Заменяет | SPEC-09 5.1; retains Performance V6/methodology v9 and isolates every fixed-gate member in a fresh process so run-level evidence has symmetric lifetime boundaries |
