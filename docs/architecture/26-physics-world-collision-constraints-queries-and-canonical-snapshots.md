...
| Дополнительные зависимости V2.10 (motor branch) | [ADR-115](adr/115-full-principal-inertia-body-successor.md), [ADR-116](adr/116-explicit-per-iteration-force-scheduling.md) |
