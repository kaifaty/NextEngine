...
| Сохранять authoritative world и воспроизводить bug | `persistence-replay` | `WorldCheckpointV4`/`ReplayManifestV4` load и replay дают ожидаемые command/event/state/ledger roots; corrupt или bootstrap RPG V3 input отклоняется до partial activation | SPEC-02, SPEC-03, SPEC-19, SPEC-21, SPEC-22 |
