...
| Replaces | SPEC-45 0.61; records a repeatable adaptive-decay synthetic pass and routes next to a separately frozen Ceramic adaptive counterfactual |
| Latest evidence | [PS-2 adaptive modal-decay control result](../development/physical-sound-adaptive-decay-control-result-ps2-2026-08-28.md) |
