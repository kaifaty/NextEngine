...
| Replaces | SPEC-45 0.62; freezes the read-only Ceramic adaptive-decay counterfactual before payload analysis |
| Latest evidence | [PS-2 Ceramic Cup adaptive counterfactual preflight](../development/physical-sound-ceramic-cup-adaptive-counterfactual-preflight-ps2-2026-08-28.md) |
