...
| Replaces | SPEC-45 0.26; makes exact-domain E2/E3 claim closure executable and records the current fallback-only result without changing corpus admission, quality acceptance or runtime/content contracts |
| Latest evidence | [PS-2 exact-domain E2/E3 claim matrix](../development/physical-sound-domain-claims-matrix-ps2-2026-08-28.md) |
