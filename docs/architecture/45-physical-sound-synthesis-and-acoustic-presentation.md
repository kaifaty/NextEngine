...
| Replaces | SPEC-45 0.76; freezes the inputs and fallback-only states for one report-only modal-observation registry build |
| Latest evidence | [PS-2 modal-observation registry V0 preregistration](../development/physical-sound-modal-observation-registry-preregistration-ps2-2026-08-28.md) |
