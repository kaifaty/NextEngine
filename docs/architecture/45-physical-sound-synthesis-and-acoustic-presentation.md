...
| Replaces | SPEC-45 0.78; freezes object/family batch roles and permits only zero-member-payload archive discovery next |
| Latest evidence | [PS-2 REALIMPACT object-grouped metal batch preregistration](../development/physical-sound-realimpact-metal-batch-preregistration-ps2-2026-08-28.md) |
