...
| Replaces | SPEC-45 0.67; rejects source-derived salience transfer on the independent Iron Skillet observation and requires bounded method research before another implementation or object |
| Latest evidence | [PS-2 Iron Skillet observation result](../development/physical-sound-realimpact-iron-skillet-observation-result-ps2-2026-08-28.md) |
