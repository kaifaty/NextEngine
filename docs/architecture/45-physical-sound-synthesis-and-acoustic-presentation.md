...
| Replaces | SPEC-45 0.58; freezes the read-only fixed-input Ceramic Cup multi-output counterfactual before real-payload analysis |
| Latest evidence | [PS-2 Ceramic Cup multi-output counterfactual preflight](../development/physical-sound-ceramic-cup-multioutput-counterfactual-preflight-ps2-2026-08-28.md) |
