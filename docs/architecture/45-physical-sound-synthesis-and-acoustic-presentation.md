...
| Replaces | SPEC-45 0.46; records the hash-closed Pitcher execution preflight while retaining sealed audio payloads and all measured-transfer, material, quality, admission and production blocks |
| Latest evidence | [PS-2 REALIMPACT Pitcher execution preflight](../development/physical-sound-realimpact-pitcher-execution-preflight-ps2-2026-08-28.md) |
