...
| Replaces | SPEC-45 0.65; verifies the independent object's archive structure and freezes a one-impact observation protocol before payload access without promoting real-observation or mechanics credit |
| Latest evidence | [PS-2 Iron Skillet discovery and observation protocol](../development/physical-sound-realimpact-iron-skillet-discovery-and-observation-protocol-ps2-2026-08-28.md) |
