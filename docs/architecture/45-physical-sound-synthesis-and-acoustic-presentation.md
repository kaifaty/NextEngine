...
| Replaces | SPEC-45 0.73; records all-region common-pole method transfer on the opened real Iron block and requires an object-disjoint internet holdout before broader credit |
| Latest evidence | [PS-2 existing-Iron broad-band V2 result](../development/physical-sound-realimpact-broadband-v2-result-ps2-2026-08-28.md) |
