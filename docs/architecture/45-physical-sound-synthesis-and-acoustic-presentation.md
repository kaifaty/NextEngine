...
| Replaces | SPEC-45 0.43; records the supported exact-coordinate-weld REALIMPACT geometry preflight while retaining sealed payloads and all real-transfer, material, quality, admission and production blocks |
| Latest evidence | [PS-2 REALIMPACT exact-weld geometry preflight](../development/physical-sound-realimpact-exact-weld-geometry-preflight-ps2-2026-08-28.md) |
