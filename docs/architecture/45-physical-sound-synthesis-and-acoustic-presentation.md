...
| Replaces | SPEC-45 0.55; records shared multi-listener decay mismatch, rejects the simple low-frequency and listener-local causes, and routes next to a synthetic multi-output control |
| Latest evidence | [PS-2 Ceramic Cup observation diagnostic result](../development/physical-sound-ceramic-cup-observation-diagnostic-result-ps2-2026-08-28.md) |
