...
| Replaces | SPEC-45 0.57; records a repeatable synthetic multi-output control pass and routes next to a separately frozen read-only Ceramic counterfactual |
| Latest evidence | [PS-2 multi-output decay control result](../development/physical-sound-multioutput-decay-control-result-ps2-2026-08-28.md) |
