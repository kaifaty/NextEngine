...
| Replaces | SPEC-45 0.42; records the rejected geometry-only REALIMPACT preflight and exact-coordinate-weld discriminator while retaining sealed payloads and all real-transfer, material, quality, admission and production blocks |
| Latest evidence | [PS-2 REALIMPACT geometry-only preflight](../development/physical-sound-realimpact-geometry-preflight-ps2-2026-08-28.md) |
