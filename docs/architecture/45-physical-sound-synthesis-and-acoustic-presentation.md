...
| Replaces | SPEC-45 0.71; records the capacity-gated rejection of the first existing-Iron broad-band counterfactual and requires a dense synthetic scaling/discriminator control before any larger real envelope |
| Latest evidence | [PS-2 existing-Iron broad-band counterfactual result](../development/physical-sound-realimpact-broadband-counterfactual-result-ps2-2026-08-28.md) |
