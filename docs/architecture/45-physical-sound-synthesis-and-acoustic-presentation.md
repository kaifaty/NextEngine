...
| Replaces | SPEC-45 0.77; records a byte-identical report-only registry and permits only an object-grouped batch protocol next |
| Latest evidence | [PS-2 modal-observation registry V0 result](../development/physical-sound-modal-observation-registry-result-ps2-2026-08-28.md) |
