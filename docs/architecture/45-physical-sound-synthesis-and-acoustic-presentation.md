...
| Replaces | SPEC-45 0.74; freezes a verified zero-payload object-disjoint internet holdout and permits only a separately frozen one-impact observation protocol |
| Latest evidence | [PS-2 broad-band independent holdout discovery result](../development/physical-sound-realimpact-broadband-holdout-discovery-result-ps2-2026-08-28.md) |
