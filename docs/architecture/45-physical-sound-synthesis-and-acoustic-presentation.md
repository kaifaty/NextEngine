...
| Replaces | SPEC-45 0.79; records zero-payload batch discovery and permits one exact payload/candidate protocol next |
| Latest evidence | [PS-2 REALIMPACT object-grouped metal batch discovery result](../development/physical-sound-realimpact-metal-batch-discovery-result-ps2-2026-08-28.md) |
