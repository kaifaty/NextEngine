...
| Replaces | SPEC-45 0.60; freezes the source-faithful adaptive modal-decay synthetic control before any further real reuse |
| Latest evidence | [PS-2 adaptive modal-decay control preflight](../development/physical-sound-adaptive-decay-control-preflight-ps2-2026-08-28.md) |
