...
| Replaces | SPEC-45 0.66; implements and hash-closes the independent one-impact execution runner before payload access without promoting real-observation or mechanics credit |
| Latest evidence | [PS-2 Iron Skillet execution preflight](../development/physical-sound-realimpact-iron-skillet-execution-preflight-ps2-2026-08-28.md) |
