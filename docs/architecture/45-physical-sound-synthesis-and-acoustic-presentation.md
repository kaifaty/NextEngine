...
| Replaces | SPEC-45 0.72; records dense synthetic support and sparse-parent equivalence for the rank-7 partial-SVD common-pole core, and permits only a frozen all-region Iron V2 counterfactual |
| Latest evidence | [PS-2 dense broad-band scaling control result](../development/physical-sound-dense-broadband-scaling-control-result-ps2-2026-08-28.md) |
