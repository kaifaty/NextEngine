...
| Replaces | SPEC-45 0.50; narrows the causal interpretation of the immutable Pitcher rejection after the observation-admission audit, while retaining all material, quality, admission and production blocks |
| Latest evidence | [PS-2 REALIMPACT Pitcher causal audit](../development/physical-sound-pitcher-causal-audit-ps2-2026-08-28.md) |
