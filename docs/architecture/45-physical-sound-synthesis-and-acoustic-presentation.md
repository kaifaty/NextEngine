...
| Replaces | SPEC-45 0.44; records the frozen Pitcher-only calibration protocol while retaining sealed audio payloads and all measured-transfer, material, quality, admission and production blocks |
| Latest evidence | [PS-2 REALIMPACT Pitcher calibration preregistration](../development/physical-sound-realimpact-pitcher-calibration-preregistration-ps2-2026-08-28.md) |
