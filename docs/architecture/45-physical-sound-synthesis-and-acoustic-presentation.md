...
| Replaces | SPEC-45 0.56; freezes the synthetic 15-output spatial-modal-power control before any reuse of real observations |
| Latest evidence | [PS-2 multi-output decay control preflight](../development/physical-sound-multioutput-decay-control-preflight-ps2-2026-08-28.md) |
