...
| Replaces | SPEC-45 0.59; rejects spatial aggregation as the Ceramic remedy and routes next to a source-faithful adaptive-decay synthetic control |
| Latest evidence | [PS-2 Ceramic Cup multi-output counterfactual result](../development/physical-sound-ceramic-cup-multioutput-counterfactual-result-ps2-2026-08-28.md) |
