...
| Replaces | SPEC-45 0.45; records the parity-checked Pitcher calibration runner preflight while retaining sealed audio payloads and all measured-transfer, material, quality, admission and production blocks |
| Latest evidence | [PS-2 REALIMPACT Pitcher runner preflight](../development/physical-sound-realimpact-pitcher-runner-preflight-ps2-2026-08-28.md) |
