...
| Replaces | SPEC-45 0.70; records synthetic end-to-end support for input-driven Gabor discovery, common-pole recovery, duplicate pruning, amplitude fitting and reconstruction, and requires a frozen existing-Iron counterfactual before any real-transfer claim |
| Latest evidence | [PS-2 broad-band common-pole control result](../development/physical-sound-broadband-common-pole-control-result-ps2-2026-08-28.md) |
