...
| Replaces | SPEC-45 0.68; isolates the fixed 900 ms persistence observation as an Iron Skillet failure cause and requires synthetic subband common-pole proof before another real object or mechanics |
| Latest evidence | [PS-2 Iron selector/tail diagnostic result](../development/physical-sound-realimpact-selector-tail-diagnostic-result-ps2-2026-08-28.md) |
