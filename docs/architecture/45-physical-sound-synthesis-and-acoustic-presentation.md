...
| Replaces | SPEC-45 0.75; records object-disjoint real common-pole method transfer and permits a report-only modal-observation registry without quality/domain/runtime promotion |
| Latest evidence | [PS-2 Iron Mortar broad-band independent holdout result](../development/physical-sound-realimpact-broadband-holdout-result-ps2-2026-08-28.md) |
