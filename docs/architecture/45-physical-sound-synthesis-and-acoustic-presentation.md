...
| Replaces | SPEC-45 0.80; freezes exact batch payload, decoder, candidate and gate semantics before new waveform access |
| Latest evidence | [PS-2 REALIMPACT metal batch payload/candidate protocol](../development/physical-sound-realimpact-metal-batch-protocol-ps2-2026-08-28.md) |
...
zero-access execution runner and deterministic fixtures.
