...
| Replaces | SPEC-45 0.36; rejects higher regular-panel quadrature as the cause of the analytical refinement failure and routes next to an independent Galerkin/singular-quadrature solver control |
| Latest evidence | [PS-2 BEM panel-quadrature discriminator](../development/physical-sound-bem-quadrature-discriminator-ps2-2026-08-28.md) |
