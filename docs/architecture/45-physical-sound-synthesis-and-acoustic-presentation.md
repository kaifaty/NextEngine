...
| Replaces | SPEC-45 0.35; records a reproducible analytical boundary-solver control whose absolute field gates pass but whose preregistered refinement gate fails, so no BEM/FFAT oracle credit is granted |
| Latest evidence | [PS-2 analytical boundary-solver control](../development/physical-sound-bem-analytical-control-ps2-2026-08-28.md) |
