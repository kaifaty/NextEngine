...
| Replaces | SPEC-45 0.41; records the hash-closed object-disjoint REALIMPACT geometry-spatial-transfer preregistration while retaining the sealed-payload, material, quality, admission and production blocks |
| Latest evidence | [PS-2 REALIMPACT geometry-spatial-transfer preregistration](../development/physical-sound-realimpact-geometry-spatial-transfer-preregistration-ps2-2026-08-28.md) |
