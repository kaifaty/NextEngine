...
| Replaces | SPEC-45 0.53; records the repeated `78_CeramicCup` observation rejection and blocks another object or mechanics attempt pending a bounded offline causal diagnostic |
| Latest evidence | [PS-2 REALIMPACT Ceramic Cup observation result](../development/physical-sound-realimpact-ceramic-cup-observation-result-ps2-2026-08-28.md) |
