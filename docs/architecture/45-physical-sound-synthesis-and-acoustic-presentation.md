...
| Replaces | SPEC-45 0.69; records synthetic support for the preselected Gabor/subband common-pole core and requires broad-band discovery, duplicate pruning and reconstruction proof before real reuse |
| Latest evidence | [PS-2 subband common-pole control result](../development/physical-sound-subband-common-pole-control-result-ps2-2026-08-28.md) |
