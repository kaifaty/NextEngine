...
| Replaces | SPEC-45 0.54; freezes the bounded offline listener-axis diagnostic after repeated observation-gate failure, without reopening mechanics or acquisition |
| Latest evidence | [PS-2 Ceramic Cup observation diagnostic preflight](../development/physical-sound-ceramic-cup-observation-diagnostic-preflight-ps2-2026-08-28.md) |
