...
| VS-12 Security/governance review | Security & Governance | `next gate VS-12 --scenario vertical-v1 --review-packet` | SEC-01…07, LIC-01, GOV-01 pass; legal importer approval exact release; VS-01…VS-11 and VS-13…VS-15 child manifests PASS; traceability completeness 100%; all required hashes verify | signed review record, SBOM, scans, traceability report, required HumanReviewDecision records | do not declare conformance; engine-only review MAY proceed without importer release but not vertical-v1 acceptance |
