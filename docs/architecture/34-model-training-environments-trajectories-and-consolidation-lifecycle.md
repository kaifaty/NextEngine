...
| Supersedes | SPEC-34 1.14; records the V8 command repair without optimizer or learned-quality admission |
| Additional dependencies 1.15 | [ADR-110](adr/110-applied-command-stop-window.md) |
