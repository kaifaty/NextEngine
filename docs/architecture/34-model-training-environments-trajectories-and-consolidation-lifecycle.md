...
| Supersedes | SPEC-34 1.8; admits only the consumer-backed ADR-070 reference-tracking environment/manifest subset while the general lifecycle remains Proposed |
