...
ADR-058/SPEC-35, ADR-064, ADR-065 and ADR-070 accept only the bounded
first-humanoid V2 standing/flat-command/curriculum environments plus the
...
SPEC-42 future world-solver advice does not expand this closed enum or reuse
