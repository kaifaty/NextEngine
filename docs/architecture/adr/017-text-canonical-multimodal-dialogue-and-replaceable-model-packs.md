...
[ADR-099](099-bounded-streaming-tts-through-ai-host-and-audio-scene.md) и
[SPEC-47](../47-streaming-tts-and-spatial-speech-presentation.md) выделяют
...
ADR-017 не заменяет ADR-005, ADR-022, ADR-030 или ADR-099. Принятие широкого proposal требует
