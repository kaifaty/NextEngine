...
| Superseded by | ADR-123/124 additive diagnostic inputs and exact V11 standing consumers; [ADR-126](126-corrected-body-walking-environment.md) adds native walking; original census unchanged |
