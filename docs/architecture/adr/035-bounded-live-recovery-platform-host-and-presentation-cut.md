...
| Заменён | Physical representation требования current+previous raw session generations узко заменено [ADR-037](037-packed-session-object-storage.md); logical retention, cadence, recovery evidence, platform-host binding и presentation cut остаются Accepted |
