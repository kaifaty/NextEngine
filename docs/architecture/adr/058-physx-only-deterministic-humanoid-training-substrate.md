...
но не native serialization. Restore активируется только после fresh-scene
import и exact continuation probe.
...
profiles stay Proposed beyond the deterministic Stage 0 substrate.
