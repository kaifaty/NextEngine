# ADR-099: Bounded streaming TTS through `ai-host` and `AudioScene`
...
The exact contracts, bounds and mapped checks are defined in SPEC-47.
...
status updates to SPEC-47, SPEC-08/SPEC-16, index, routing and traceability.
