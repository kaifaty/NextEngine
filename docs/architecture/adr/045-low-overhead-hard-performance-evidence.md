...
| Superseded by | Allocator-retention clauses and Performance V2/V3 tooling schemas are superseded by [ADR-049](049-performance-evidence-without-allocator-instrumentation.md). [ADR-082](082-linux-first-development-and-deferred-windows-host.md) defers Windows hard execution to pre-R7 bring-up. Low-overhead evidence, THOTH budgets and no-retry policy remain Accepted. |
