...
| Заменяет | SPEC-28 2.2; records the downstream R5f exact base-skinning consumer without changing animation or Replay ownership |
...
Текущий bounded R5 consumer развивает R2 content prerequisite шестью принятыми
...
Это закрывает только bounded R5a–R5f production path. Layered/general graph,
non-identity retarget, physical IK, animation LOD/cadence matrix, authored pose
correctives, articulation/hybrid motion и полный 10 000-cycle
