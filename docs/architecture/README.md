...
Summary считает indexed architecture documents без frozen research annex. Requirement, failure, gate и technology counts сохраняют Accepted packet 1.4, пока candidate не promoted.

| Metric | Value |
|---|---:|
| Markdown documents | 37 |
| Subsystem SPEC files | 16 |
| Decision ADR files | 16 |
| Vertical gates | 15 |
| Requirements | 78 |
| Failure paths | 24 |
| Technology rows | 23 |
| Proposed technology rows | 16 |
