...
| SPEC-38 | [Continuum material physics](38-continuum-material-physics.md) | Accepted for water (3.1, 2026-09-03: practice 1 implemented — the face-sharing rule, `WaterLatticeRegionV1` and `CONTINUUM-WATER-LATTICE-P1` through `xtask water-lattice`; 3.0, 2026-09-03; the exact table, flow network and buoyancy batch of ADR-100/103/105 with SPEC-26 2.8 schemas, tiers and practices, presentation and failure semantics; the particle lanes stay research), other material lanes moved to SPEC-39; 2.4 records `CONTINUUM-WATER-BUOYANCY-P1` through `xtask water-buoyancy` (WB1); 2.3 records `CONTINUUM-WATER-PRESENT-P1 = PASS` (WP1 presentation stage in the game root); 2.2 closes the water authority ladder on the exact table and flow network (ADR-104), binds the water tiers and practices, keeps the particle lanes as research reports; `CONTINUUM-WATER-VOLUME-P1` and `CONTINUUM-WATER-FLOW-P1` pass |
