...
| Заменяет | SPEC-30 3.1; updates the current atomic project activation type after R4b |
...
interpretation and profile support before `ActivatedProjectV5` publication.
