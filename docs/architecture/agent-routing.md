...
| Future world substrates and arcane magic: mana/arcane resources, telekinesis, spell execution, fields, ley networks, artifacts, anti-magic, arcane ecology and physical/vital/identity coupling (`Proposed`) | [SPEC-39](39-world-substrate-composition.md), [SPEC-40](40-arcane-substrate-and-physical-magic.md), [SPEC-13](13-gameplay-mechanics-mod-packages-and-agent-authoring.md), [SPEC-19](19-rpg-domain-and-narrative-state.md), [SPEC-21](21-deterministic-runtime-primitives-command-ledger-and-causal-identity.md), [SPEC-03](03-assets-world-streaming-and-persistence.md), [SPEC-17](17-project-composition-configuration-and-application-lifecycle.md), [SPEC-24](24-content-catalog-bundle-and-neutral-asset-schemas.md), [SPEC-25](25-world-partition-streaming-admission-and-persistent-spatial-objects.md), [SPEC-26](26-physics-world-collision-constraints-queries-and-canonical-snapshots.md), [SPEC-30](30-presentation-extraction-and-render-content.md), [SPEC-37](37-layered-physical-world.md); add [SPEC-36](36-continuum-material-physics.md) or [SPEC-38](38-structural-vegetation-physics.md) only for those destination couplers and [SPEC-31](31-autonomous-quest-lifecycle-and-narrative-director.md) only for divine/identity intent | ADR-074, ADR-008, ADR-020, ADR-022, ADR-046, ADR-058, ADR-071, ADR-073; add ADR-072 only for continuum coupling | none while arcane A0 is open; future `ARCANE-RESERVOIR-REF-P1`, `ARCANE-MECHANICS-P1`, `ARCANE-RIGID-COUPLING-P1`, `ARCANE-PERSISTENCE-P1`, `ARCANE-CROSS-TARGET-P1` plus play, persistence-replay, content-package, platform and conditional performance; later owner-specific `ARCANE-THERMAL-P1`, `ARCANE-CONTINUUM-P1`, `ARCANE-VEGETATION-P1`, `ARCANE-VITAL-P1`, `ARCANE-IDENTITY-P1` |
