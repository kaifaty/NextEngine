...
| Assets, persistence, neutral content and current partition/population catalogs | [SPEC-03](03-assets-world-streaming-and-persistence.md), [SPEC-24](24-content-catalog-bundle-and-neutral-asset-schemas.md), [SPEC-25](25-world-partition-streaming-admission-and-persistent-spatial-objects.md) | ADR-026, ADR-014, ADR-044, ADR-048, ADR-051, ADR-072 | content-package |
...
SPEC-16/ADR-017 (dialogue model packs), SPEC-20/ADR-052/ADR-072 (current R4a
calendar/routine and R4b population/graph), the broader navigation candidate in SPEC-08, SPEC-23
