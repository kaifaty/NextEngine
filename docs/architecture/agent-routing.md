...
| Project composition, exact lock and atomic activation | [SPEC-17](17-project-composition-configuration-and-application-lifecycle.md) | ADR-018, ADR-048, ADR-073, ADR-074 for the current cognition/activity roots and profile successors | fast, content-package |
...
| Current performance budgets and evidence | [SPEC-09](09-tooling-sdk-and-observability.md), [SPEC-12](12-vertical-slice-conformance.md), [SPEC-35](35-deterministic-humanoid-training-substrate.md) for R5 | ADR-016, ADR-036, ADR-038, ADR-045, ADR-049, ADR-060, ADR-061, ADR-062, ADR-063, ADR-074 for R4 tier cognition | performance |
