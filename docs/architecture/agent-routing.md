...
| Assets, persistence, neutral content and current partition/population/cognition catalogs | [SPEC-03](03-assets-world-streaming-and-persistence.md), [SPEC-24](24-content-catalog-bundle-and-neutral-asset-schemas.md), [SPEC-25](25-world-partition-streaming-admission-and-persistent-spatial-objects.md), [SPEC-32](32-npc-cognition-intention-lifecycle-and-deterministic-behavior-inference.md) | ADR-026, ADR-014, ADR-044, ADR-048, ADR-051, ADR-072, ADR-073 | content-package |
...
| Current R4c cognition owner vertical | [SPEC-32](32-npc-cognition-intention-lifecycle-and-deterministic-behavior-inference.md), [SPEC-06](06-ai-agents-perception-and-memory.md), [SPEC-02](02-runtime-ecs-and-data.md), [SPEC-03](03-assets-world-streaming-and-persistence.md), [SPEC-17](17-project-composition-configuration-and-application-lifecycle.md), [SPEC-20](20-world-simulation-and-population-lifecycle.md), [SPEC-21](21-deterministic-runtime-primitives-command-ledger-and-causal-identity.md), [SPEC-22](22-schema-registry-compatibility-and-migration.md), [SPEC-24](24-content-catalog-bundle-and-neutral-asset-schemas.md) | ADR-005, ADR-016, ADR-021, ADR-022, ADR-046, ADR-048, ADR-056, ADR-072, ADR-073 | focused cognition tests, fast, play, persistence-replay, content-package, host-check; conditional `performance --scenario r4-100npc --mode report` without a cognition-performance claim |
...
| Project composition, exact lock and atomic activation | [SPEC-17](17-project-composition-configuration-and-application-lifecycle.md) | ADR-018, ADR-048, ADR-073 for the current cognition root/profile successor | fast, content-package |
...
| Audio and current bounded World Services graph/query | [SPEC-08](08-audio-navigation-and-world-services.md), [SPEC-20](20-world-simulation-and-population-lifecycle.md) | ADR-072 for graph/population changes | play; content-package/persistence-replay and conditional r4-100npc report when graph/population changes |
...
ADR-029/ADR-031), the SPEC-32 R4d social/economy and tier-wide cognition remainder,
