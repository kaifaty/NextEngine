...
| `cargo run --locked -p xtask -- performance --scenario r2-alpha-render --mode report` | `NOT_RUN` by policy on this host: the report-only workload still completed `10,000` render plans with eight visible draws, zero fallback-material draws and frame-plan hash `600fdec9fb65f0cc34368f7762a1cea35d836c22e393e5315bd8c6ded6b1132b` | No hard timing or B-12 claim; the supported Windows desktop evidence remains open. |
