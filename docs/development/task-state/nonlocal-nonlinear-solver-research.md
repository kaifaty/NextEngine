...
2. Preserve R20R46 semantic `e1c904c7...1ec5`, both practical certificate
   ...
   R20R47 report-only third inverse-contraction audit over the exact R46 prefix;
   allow exactly two local replacements and one capture, but add no third RHS
   audit or replacement, unrelated factorization/solve, counterflow replay,
