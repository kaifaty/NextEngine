...
1. Preserve the integrated R63ZM revision-5 source hashes, fixed artifact and
   ...
   ceiling. Preserve the R63ZN preflight only as reachability evidence and
   implement the separately frozen revision-2 initial-prefix candidate/checker
   without modifying R63ZM. Derive `x0` before consuming
