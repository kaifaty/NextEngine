...
- **Next:** research/freeze R63ZB deterministic K2 exported-lane PCG through
  states `0..2`, with sealed centers and final independent R63Y affine
  verification. No adaptive stop, corpus, timing, GPU/runtime or production.
...
3. Research/freeze R20R63ZB sealed-center K2 PCG for the exported lane and
