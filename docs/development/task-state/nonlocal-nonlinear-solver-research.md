...
2. Preserve R20R42 semantic `e435daf5...9a41`, R20R41 semantic
   ...
   R20R43 depth-eight passive-solution refinement; allow one local replacement
   and its unchanged NNQP transitions, but add no unrelated
