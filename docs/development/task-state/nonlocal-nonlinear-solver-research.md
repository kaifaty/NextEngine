...
2. Preserve R20R45 semantic `4263411e...6080`, R20R44 semantic
   ...
   R20R46 default-off two-target trajectory with original depth eight and
   second depth 16; allow exactly two local replacements and unchanged NNQP
   transitions, but add no unrelated factorization/solve, counterflow replay,
