...
2. Preserve R20R47 semantic `7ce17f95...1d83` and all four third inverse roots,
   ...
   R20R48 report-only third centered-solution audit over the exact R46 prefix;
   allow exactly two local replacements and one capture, but add no third
   replacement, unrelated factorization/solve, counterflow replay,
