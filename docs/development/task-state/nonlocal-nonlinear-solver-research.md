...
| Current frontier | `D7R20R63M_EXPORTED_FACTOR_WIDE_PCG_CANDIDATE / D7R20R63N_DIRECT_RECTANGULAR_PRODUCT_NOT_CONTAINED / D7R20R63O_CANONICAL_DEFECT_TRANSPORT_FROZEN / D7R20R63O_IMPLEMENTATION_NEXT` |
| Updated | `2026-08-26` |
...
- **Next:** implement only the frozen R63O transport discriminator. Reproduce
  both R63N raw initial failures first. Do not inflate/shrink `E`, fit a
  tolerance, let bounds drive PCG, change the starts/operator/precision, add
  sparse work, replace state, run timing or infer runtime/GPU/production
  authority. R64/R65 remain blocked.
