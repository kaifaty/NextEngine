...
2. Preserve R20R51 semantic `48df3b26...adca` and all five case roots,
   ...
   R20R52 report-only centered audit over the exact counterflow final successful
   inverse; recompose but do not apply the refined direction error, and add no
   new direction/trial, root-selected branch, prodK, unrelated
   factorization/solve, counterflow replay,
