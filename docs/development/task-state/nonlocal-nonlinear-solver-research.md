...
| Current frontier | `D7R20R63I_WIDE_RHS_SIGN_CERTIFICATE_REJECTED / D7R20R63J_ORIGINAL_RESIDUAL_REFINEMENT_FROZEN / D7R20R63J_IMPLEMENTATION_NEXT` |
| Updated | `2026-08-26` |
...
- **R20R63J frozen:** construct one common verified left defect and one
  ...
  checkpoint.
- **Next:** implement only the frozen R63J shadow correction/certificates. Do
  not adapt the checkpoint ladder, replace state, execute the following NNQP
  decision, add GMRES/LSQR/SVD, change rank/rows/regularization, time the host
  or infer runtime/GPU/production authority. R64/R65 remain blocked.
