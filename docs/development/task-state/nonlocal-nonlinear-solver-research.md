...
2. Preserve R20R48 semantic `7d4d7a9e...7802` and all third center roots,
   ...
   R20R49 default-off three-target trajectory over the exact R46 prefix;
   allow exactly three local replacements and capture only the next boundary,
   but add no fourth target-specific audit, unrelated factorization/solve,
   counterflow replay,
