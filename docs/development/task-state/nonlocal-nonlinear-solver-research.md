...
2. Preserve R20R50 semantic `190ac441...d86e`, all five generic certificate
   ...
   R20R51 default-off root-agnostic verifier over all five v4 cases; reset the
   inherited cap 32 per case and preserve counterflow unchanged, but add no
   root-selected branch, prodK, unrelated
