...
- **Remaining uncertainty:** whether the C++ boundary and its receipts remain
  source-auditable with no hidden helper path, and whether all five legacy
  stdout regressions remain exact after the additive API change.
