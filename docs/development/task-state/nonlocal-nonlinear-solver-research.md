...
2. Preserve R20R49 semantic `719e0d50...f3cc`, all three practical roots and
   ...
   R20R50 default-off root-agnostic verifier over one torsion replay; allow a
   practical depth-16 certificate on each legacy inverse failure up to the
   inherited cap 32, but add no root-selected branch, prodK, unrelated
