...
- **Next:** research/freeze only a certificate-detail decomposition of
  affine-image center, representation radii and `1/(1-rho_upper)`
  amplification, with identity-sealed component swaps. Do not change an
  operator, certificate, precision, iteration depth or tolerance.
...
3. Preserve reviewed R20R63ZB result semantic `acfe6baf...a709ebf`, stdout
   ...
   executable. Do not apply a correction, fit a threshold, run timing or
   infer runtime/GPU/production authority.
