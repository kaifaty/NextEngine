...
- **R63ZN accepted-path checker:** the first 1,120-byte author receipt was
  ...
  allocation probes are zero and six targeted mutation routes discriminate.
  Fixed rejection receipts, complete controls and fresh review remain pending,
  so there is still no admitted R63ZN result.
