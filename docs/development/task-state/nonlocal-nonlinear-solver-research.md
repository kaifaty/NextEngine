...
| Current frontier | `D7R20R63J_EXPORTED_FACTOR_REFINED_RHS_CANDIDATE / D7R20R63K_FACTOR_STANDARD_REFINEMENT_FROZEN / D7R20R63K_IMPLEMENTATION_NEXT` |
| Updated | `2026-08-26` |
...
- **Next:** implement only the frozen R63K factor-refinement discriminator. Do
  not adapt the iteration ladder, add GMRES/PCG/MINRES, replace state, change
