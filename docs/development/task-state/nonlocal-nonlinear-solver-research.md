...
| Current frontier | `D7R20R63I_EXPORTED_FACTOR_RHS_FROZEN / D7R20R63I_IMPLEMENTATION_NEXT` |
| Updated | `2026-08-26` |
...
- **Next:** implement only the frozen R63I shadow solves/certificates. Do not
  replace the parent solution, execute a following NNQP decision, refine,
  change rank/rows/regularization, widen runtime by default, run timing or
