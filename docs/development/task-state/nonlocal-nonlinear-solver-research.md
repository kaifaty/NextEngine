...
3. Preserve reviewed R20R63ZB result semantic `acfe6baf...a709ebf`, stdout
   ...
   `INCONCLUSIVE` and receives no third repair or review. Preserve R63ZK author
   snapshot `33e24152`, stdout `37129010...9041`, result
   `e8cd812c...c95e2` as author-only evidence. Preserve initial review
   `NO-GO` and harness `23ccf6f1...fbff`. Implement the frozen revision-2 batch,
   run Dev/two Release and exact regressions, then issue the single re-review
   packet. On re-review `GO`, freeze only a portable product-representation
