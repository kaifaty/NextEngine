...
- **Next:** research and freeze only R63ZH componentwise production of the
  common center residual `v-Mx`: identify the maximum row and separately bind
  `v_i`, `M_i x`, their exact/twofold residual and tangent/common lane origin.
  Do not correct the certificate or change operator, precision or tolerance.
...
3. Preserve reviewed R20R63ZB result semantic `acfe6baf...a709ebf`, stdout
   ...
   `AFFINE_IMAGE_CENTER_RESIDUAL_SUFFICIENT` interpretation. Research and
   freeze only the componentwise common center producer `v-Mx`: identify the
   maximum row and bind separate operand, product and exact/twofold residual
   identities across immutable tangent/common lanes. Do not apply a
