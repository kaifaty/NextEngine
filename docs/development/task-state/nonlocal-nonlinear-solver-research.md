...
- **Next:** research/freeze R63Z around a factorized/sparse candidate producer
  and immutable twofold producer/verifier artifact. Preserve final affine
  cancellation and prove identity, operator correspondence, stale/mutation
  rejection and failure atomicity before implementation. No corpus, timing,
  GPU, runtime or production inference.
