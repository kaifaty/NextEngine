...
2. Preserve R20R39 semantic `83e1f738...1bac`, R20R38 semantic
   ...
   `e7b9acaf...0f73` and all parents. Implement only report-only R20R40
   directional Krawczyk audit; add no factorization/inverse column/solve,
   correction apply, counterflow replay, NNQP decision, state,
   tolerance/cap/Armijo change, retry, tuning or timing.
