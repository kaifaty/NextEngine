...
| Current frontier | `D7R20R63L_EXPORTED_FACTOR_WIDE_STANDARD_REFINEMENT_CANDIDATE / D7R20R63M_PRECONDITIONED_CG_FROZEN / D7R20R63M_IMPLEMENTATION_NEXT` |
| Updated | `2026-08-26` |
...
- **Next:** implement only the frozen R63M PCG discriminator. Do not add
  restarts, residual replacement, GMRES/MINRES, strict/compensated binary64,
  matrix-free integration, state replacement, rank/row/regularization change,
  host timing or runtime/GPU/production inference. R64/R65 remain blocked.
