...
| Current frontier | `D7R20R63F_LOCAL_REPRESENTATIVE_NULLSPACE_REFUTED / D7R20R63G_NO_DROP_RECTANGULAR_ARITHMETIC_RESEARCH_NEXT` |
| Updated | `2026-08-26` |
...
- **Next:** stop representative correction and research/freeze R63G around a
  no-drop rectangular factor/iteration correspondence. Compare direct
  Householder QR/QRCP and Golub--Kahan/LSQR arithmetic before an RHS, retain all
  102 rows and explicitly discriminate binary64 from bounded wider
  accumulation. No fitted rank threshold, row removal, regularization,
  runtime/GPU/production inference or timing. R64/R65 remain blocked.
