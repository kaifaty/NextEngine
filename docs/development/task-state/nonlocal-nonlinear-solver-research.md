...
| Current frontier | `D7R20R63K_WIDE_FACTOR_STANDARD_REFINEMENT_REJECTED / D7R20R63L_WIDE_CONVERGENCE_FRONTIER_FROZEN / D7R20R63L_IMPLEMENTATION_NEXT` |
| Updated | `2026-08-26` |
...
- **R20R63L frozen:** replay exact R63K, retain only the two wide iteration-16
  ...
  forbidden.
- **Next:** implement only the frozen R63L convergence frontier. Do not stop
  early after a pass, extend beyond 32, add Krylov/low-rank correction, replace
