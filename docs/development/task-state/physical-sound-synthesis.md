...
| Field | Value |
| --- | --- |
| Status | `PS2_PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_ADAPTIVE_COUNTERFACTUAL_REJECTED / CERAMIC_METHOD_DEVELOPMENT_CLOSED / CURRENT_PEAK_SELECTOR_UNSUPPORTED / SALIENCE_SELECTOR_SYNTHETIC_CONTROL_NEXT / INDEPENDENT_OBJECT_REQUIRED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN / PASS_DISABLED / P1_BLOCKED` |
| Updated | `2026-08-28` |
...
- **Next action:** Freeze a synthetic source-faithful salience-selector control
  with known modes and dense low-frequency artifacts. Do not reuse Ceramic.
...
2. Freeze a source-faithful salience-selector synthetic control; do not reuse
   Ceramic, tune, fetch, run physics or access Planter audio.
