...
| H4: automatic validator reaches useful bounded risk | T0 truth and frozen V0 mechanics protocol now exist; E2 proves current metadata and raw `32/73` power | E3 rejects whole-project partition; no validator/shadow result | V0 implementation/mutation qualification, then S1/V1 real qualification |
