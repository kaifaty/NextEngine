...
| Field | Value |
| --- | --- |
| Status | `ROADMAP_V29_ADOPTED / Q1M_REPEAT_EXACT_ZERO_SIGNAL_SOURCE_POWER_OOD / Q1AM_SOURCE_GROWTH_NEXT / VALIDATOR_FIRST / CAUSAL_HYBRID_RESEARCH / FALLBACK_REQUIRED` |
| Updated | `2026-09-02` |
...
- **Planning authority:** [Roadmap V29](../../plans/physical-sound-synthesis-roadmap-v29.md)
  makes the independent Metal validator and a physics-locked hybrid generator
...
- **Next action:** Q1a-M must add at least seven independent internet projects,
  nine exact-Steel groups, extra reject power and a current exposure ledger.
  P0 may proceed independently; neither lane may open protected signal values.
...
| V29 Q0-M–P4 | `Q1M_SOURCE_POWER_OOD / Q1AM_SOURCE_GROWTH_NEXT / LANES_SEPARATE` | Q1-M leaves all roles empty: `2/9` projects, `23/32` protected Steel, `70/70` protected rejects and zero current freshness power. Q1a and P0/P1 must pass before real training. |

## Material transition: Q1-M requires independent source growth

- **Observation:** raw object count hid project concentration and role reuse.
- **Evidence:** Q1-M repeats exactly; `2/9` projects and `23/32` Steel fail.
- **Conclusion:** the current release is terminal source-power OOD; Q2/P2 stay
  blocked and no threshold, model, role or protected signal has opened.
- **Decision:** preserve exact Steel and unchanged `16/35` protected gates;
  grow only independent internet evidence while P0 proceeds synthetically.
- **Smallest next action:** Q1a-M metadata-only source-growth protocol.
...
- **Workspace:** Q1-M owner/protocol/result are in Git; audit, datasets, PCM,
  weights and generated audio remain external.
...
- **Next commit boundary:** V29 Q1a-M metadata-only internet source growth;
