...
- **Current conclusion:** Repeated audit `67c92621…8a42` verifies unopened
  `43_IronMortar` as an object-disjoint holdout; exact inferred observation
  shape is `3000×208375`, with zero member-payload bytes read.
...
- **Next action:** Freeze one-impact condition/audio ranges and unchanged V2
  gates before opening Iron Mortar waveform bytes.
...
| [Iron V2 result](../physical-sound-realimpact-broadband-v2-result-ps2-2026-08-28.md) and [holdout discovery result](../physical-sound-realimpact-broadband-holdout-discovery-result-ps2-2026-08-28.md), reports `f2fb359f…6a73` / `67c92621…8a42` | `IRON_BROADBAND_V2_METHOD_TRANSFER_SUPPORTED / INDEPENDENT_IRON_MORTAR_DISCOVERY_VERIFIED / HOLDOUT_OBSERVATION_PROTOCOL_NEXT` | Zero-payload discovery verifies exact `3000×208375` holdout capacity. Freeze one-impact access before waveform bytes; quality/domain remain open. |
