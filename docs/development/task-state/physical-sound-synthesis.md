...
| Field | Value |
| --- | --- |
| Status | `PS2_PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_METHOD_DEVELOPMENT_CLOSED / SALIENCE_SELECTOR_SYNTHETIC_CONTROL_SUPPORTED / SCALE_INVARIANCE_SUPPORTED / CURRENT_TOP16_COUNTEREXAMPLE_CONFIRMED / INDEPENDENT_IRON_SKILLET_DISCOVERY_FROZEN / OBSERVATION_NOT_OPENED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN / PASS_DISABLED / P1_BLOCKED` |
| Updated | `2026-08-28` |
...
- **Current conclusion:** Synthetic report `fa940710…0b3e` recovers `16/16`
  known modes versus top-16 `4/16`, with exact bin identity at three scales.
  Independent `17_IronSkillet` discovery is frozen; its payload is unopened.
...
- **Next action:** Execute the exact Iron Skillet ZIP tail/local-header discovery
  once and audit the immutable cache twice; do not open an archive member yet.
...
| [Salience-selector result](../physical-sound-salience-selector-control-result-ps2-2026-08-28.md) and [Iron Skillet preregistration](../physical-sound-realimpact-independent-observation-preregistration-ps2-2026-08-28.md), reports `fa940710…0b3e` / `85c53d80…7ead` | `SALIENCE_SELECTOR_SYNTHETIC_CONTROL_SUPPORTED / INDEPENDENT_IRON_SKILLET_DISCOVERY_FROZEN / OBSERVATION_NOT_OPENED` | Candidate recovers `16/16` versus top-16 `4/16`, exact bins repeat at three scales, and adaptive decay passes `16/16`. Metadata-only selection freezes unopened object 17; next exact ZIP discovery/audit, not payload or physics. |
...
2. Execute the frozen Iron Skillet archive-tail/local-header discovery once and
   audit twice offline; do not open member payload, tune, run physics or access Planter.
