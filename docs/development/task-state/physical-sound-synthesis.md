...
- **Current conclusion:** Batch preflight `578e143c…aec31` freezes `3/2/1/2`
  family roles; four new archives remain at zero member-payload bytes.
...
- **Next action:** Discover only four ZIP tails/local headers, audit twice, then
  freeze exact payload ranges plus candidate parameters/gates.
...
| [Registry result](../physical-sound-modal-observation-registry-result-ps2-2026-08-28.md) and [metal-batch preregistration](../physical-sound-realimpact-metal-batch-preregistration-ps2-2026-08-28.md), reports `34a7f209…daed0` / `578e143c…aec31` | `MODAL_OBSERVATION_REGISTRY_V0_BUILT / METAL_BATCH_ROLES_FROZEN / NEW_ARCHIVE_DISCOVERY_NEXT` | Eight explicit Iron/Metal objects are family-grouped `3/2/1/2`; new member payload is zero. Discover/audit ZIP entries before freezing waveform/candidate access. |
...
2. Discover and audit four new metal ZIP entries without member payload, then
   freeze exact access plus transient/residual parameters; no Planter/physics.
