...
| Field | Value |
| --- | --- |
| Status | `PS2_PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_METHOD_DEVELOPMENT_CLOSED / IRON_SKILLET_METHOD_TRANSFER_REJECTED / FIXED_TAIL_TIMING_MISMATCH_SUPPORTED / BROADBAND_COMMON_POLE_SYNTHETIC_CONTROL_SUPPORTED / IRON_BROADBAND_CAPACITY_COUNTERFACTUAL_REJECTED / DENSE_BROADBAND_SCALE_CONTROL_NEXT / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN / PASS_DISABLED / P1_BLOCKED` |
| Updated | `2026-08-28` |
...
- **Current conclusion:** Repeated Iron report `7635f8ac…075d` rejects the
  frozen real capacity envelope: 31 regions/91 bins exceed 16/48 before pole
  estimation; synthetic method support and exact scale discovery remain.
...
- **Next action:** Research and freeze a fresh-seed dense synthetic
  scaling/leakage discriminator before any Iron V2; do not select opened peaks.
...
| [Iron selector/tail diagnostic](../physical-sound-realimpact-selector-tail-diagnostic-result-ps2-2026-08-28.md), [broad-band synthetic result](../physical-sound-broadband-common-pole-control-result-ps2-2026-08-28.md) and [Iron counterfactual](../physical-sound-realimpact-broadband-counterfactual-result-ps2-2026-08-28.md), reports `02551f29…48d1` / `dcd83252…0094` / `7635f8ac…075d` | `BROADBAND_COMMON_POLE_SYNTHETIC_CONTROL_SUPPORTED / IRON_BROADBAND_CAPACITY_COUNTERFACTUAL_REJECTED / DENSE_BROADBAND_SCALE_CONTROL_NEXT` | Synthetic discovery-to-resynthesis passes, but Iron yields 31 regions/91 bins beyond 16/48 and stops before SVD. Next distinguish legitimate density from leakage on new synthetic truth; do not tune Iron. |
