...
| Field | Value |
| --- | --- |
| Status | `PS1_ENVELOPE_SPECIALIST_COMPLETE / PS2_CORPUS_RISK_NEXT / PASS_DISABLED / P1_BLOCKED` |
| Updated | `2026-08-27` |
...
- **Current conclusion:** PS-1 consensus rejects all 36 controlled mutations,
  including shuffled wood B4/B5; `Pass` stays disabled.
- **Why:** Coverage is `2/3`, `1/3`, `2/3`, but only three reject parent groups
  per split leave the 95% Wilson upper false-pass risk at `0.5615`.
- **Next action:** Start PS-2: broaden exact-domain independent real families
  and pre-register numeric risk/coverage policy before a new shadow.
...
| [SPEC-45](../../architecture/45-physical-sound-synthesis-and-acoustic-presentation.md), [AV-P0C](../physical-sound-validator-av-p0c-2026-08-27.md), [PS-1](../physical-sound-validator-ps1-2026-08-27.md), [subsystem roadmap](../../plans/physical-sound-synthesis-roadmap.md) and [implementation plan](../../plans/2026-08-27-physical-sound-domain-admission-implementation-plan.md) | `PS1_ENVELOPE_SPECIALIST_COMPLETE / SELECTIVE_PASS_DISABLED` | Consensus threshold `0.930586` rejects all 36 controlled negatives with coverage `2/3`, `1/3`, `2/3`; three parent groups still leave Wilson upper `0.5615`, so clip fallback remains mandatory. |
...
| H6: A selective specialist ensemble can safely automate admitted impact domains | PS-1 consensus rejects all 36 controlled mutations and improves calibration/shadow coverage | Three parent groups leave Wilson upper risk `0.5615`; four real objects remain outside coverage and exact domain axes are absent | Broaden independent exact-domain real objects and pre-register the PS-2 risk/coverage policy |
...
4. [Research report](../physical-sound-synthesis-research-2026-08-26.md), [quality evaluation](../physical-sound-quality-evaluation-research-2026-08-26.md),
   [automated validation](../physical-sound-automated-validation-research-2026-08-27.md), [AV-P0B](../physical-sound-corpus-benchmark-av-p0b-2026-08-27.md), [AV-P0C](../physical-sound-validator-av-p0c-2026-08-27.md), [PS-1](../physical-sound-validator-ps1-2026-08-27.md), [steel v4](../physical-sound-steel-residual-v4-2026-08-27.md) and the [implementation plan](../../plans/2026-08-27-physical-sound-domain-admission-implementation-plan.md).
...
6. Broaden independent exact-domain real families and pre-register risk versus
...
- **Workspace state:** Registry V1, mutation pack and PS-1 specialists are
  implemented; defaults/public schemas/assets/ownership are unchanged.
- **Checks:** sound `40/40`, Clippy `-D warnings`, fmt, boundary scan and byte
...
- **Quality status:** wood-B/Q30 remain exact; PS-1 closes its frozen blind spot,
  but upper risk `0.5615` and incomplete real coverage require PS-2 expansion.
