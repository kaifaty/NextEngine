...
- **Current conclusion:** Registry `e0bec857…e09e98` and report
  `34a7f209…daed0` repeat with 43 retained modes and mandatory fallback.
...
- **Next action:** Freeze object/family-grouped batch roles and exact existing
  observation identities before transient/residual candidate evaluation.
...
| [Iron V2 result](../physical-sound-realimpact-broadband-v2-result-ps2-2026-08-28.md), [Iron Mortar holdout](../physical-sound-realimpact-broadband-holdout-result-ps2-2026-08-28.md) and [registry result](../physical-sound-modal-observation-registry-result-ps2-2026-08-28.md), reports `f2fb359f…6a73` / `64bc63aa…d0cc` / `34a7f209…daed0` | `MODAL_OBSERVATION_REGISTRY_V0_BUILT / OBJECT_GROUPED_BATCH_PROTOCOL_NEXT / ABSOLUTE_PREDICTION_QUALITY_OPEN` | Two exact fallback-only records carry 43 retained modes and absolute residuals. Freeze batch roles before any candidate comparison; seeds cannot set their own threshold. |
...
2. Freeze an object/family-grouped batch manifest over exact existing
   observations before transient/residual comparison; no Planter or physics.
