...
- **Next action:** Commit and transfer the frozen source-faithful adaptive-decay
  control, then execute it twice. Any gate failure rejects the revision.
...
| [Adaptive modal-decay control preflight](../physical-sound-adaptive-decay-control-preflight-ps2-2026-08-28.md), report `f51e513a…7b49` | `ADAPTIVE_DECAY_SYNTHETIC_CONTROL_FROZEN / TWO_SYNTHETIC_RUNS_AUTHORIZED / REAL_REUSE_BLOCKED` | Manifest `926921e2…cedf` binds delayed/noisy known truth, source-derived adaptive fit, fixed-window comparator and eight checks. Any failure rejects the revision. |
...
2. Execute the frozen adaptive-decay control twice; do not tune V2, reuse
   Ceramic, cut frequencies, fetch, run physics or access Planter audio.
