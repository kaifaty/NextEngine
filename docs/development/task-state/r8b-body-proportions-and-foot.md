...
- [Symmetric settling and loaded test](../r8b-symmetric-settling-and-load-2026-09-06.md), ADR-124: fixed V11 passes1200-substep/two-second-return response, worst RMS speed0.00835923. Old-window failure remains;200m prefix not native-bit-invariant (max q2urad), explicitly reported. Exact V11 standing consumers fail bilateral ankle ROM at346/240s, q525995/526003 versus523609 inclusive. Fresh reviews, repeats/oldV8 exact;157 native tests/scoped checks pass. [Static authority discriminator](../r8b-loaded-control-authority-2026-09-06.md): V11 target-only boxes need18.577/3.395Nm expansion in two frictionless static poses; V8/physical boxes need0. Native0.05 joint friction is omitted, so no native-infeasibility claim. Third pose solver status4 is INCONCLUSIVE. Next contact-aware support-effort formulation, not a target/gain sweep, constant positive bias or contact-free G(q) shortcut. Full loaded calibration/training gates remain open.
...
26. [Two-second response PASS / loaded standing FAIL](../r8b-symmetric-settling-and-load-2026-09-06.md), [ADR-124](../../architecture/adr/124-bandwidth-settling-and-standing-diagnostics.md); [static authority result and native-friction ceiling](../r8b-loaded-control-authority-2026-09-06.md).
