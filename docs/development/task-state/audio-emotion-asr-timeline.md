...
- **Next action:** User manually tests pinned `Aniemore/wav2vec2-emotion-v1-crosslingual` revision `6634a4213bbc63f2e9613f4d827a1d29e3b5e0da`, now resident through the bounded generic adapter; then run its exact RESD-70 v2 direct/full-path screen before any default claim. Retain Nikatonika, prior WavLM and base profiles as rollback. LLM/TTS and FunctionGemma remain out of scope.
