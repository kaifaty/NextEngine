...
| Pinned DPDFNet streaming + gain prototype, 2026-08-20 | `dpdfnet==0.6.0`, `Ceva-IP/DPDFNet` commit `dd6818d00f50c836fed43a6243ebe49116de5964`, `dpdfnet2.onnx` SHA-256 `4f0ee28935b4a32abecc717d745416976565834d839601acf43031094b4dc94c`; offline 80-ms CPU probe is p50/p95 `11.45/13.32 ms`, resident post-only replay is `13/17 ms`, zero overloads and exact sample count. Pre/post gain retained `91/388` whisper frames above −75 dBFS versus post-only `21/388`, but the user reports raw sounds cleaner. The active route targets −26 dBFS with up to +32 dB at both sides and a −1 dBFS limiter; pinned online `StreamEnhancer` has no attenuation-strength input. | Reject the current double-gain route as a default-quality candidate: energy retention did not prove intelligibility or naturalness. Keep it diagnostic only, return to raw control, and require the multi-metric front-end A/B in [research](../speech-input-front-end-research-2026-08-20.md). |
