...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V44](plans/physical-sound-synthesis-roadmap-v44.md) is `ACTIVE / B0R_R0R_C1_G0A_G0B0_COMPLETE / G0B1A_PAYLOAD_PASS / G0B1B_TARGET_AUDIT_COMPLETE / NORMALIZATION_PASS / 12_24_48_96_MODE_CAPS_REJECT / TARGET_REPRESENTATION_REDESIGN_REQUIRED / CORPUS_CREDIT_ZERO / 5_STEEL_PARENTS / ZERO_DESCRIPTOR_COMPLETE / G0B1C_NEXT / PSEL_BLOCKED / V0S_OPEN / V0_BLOCKED_BY_POWER / TRAINING_BLOCKED / OFFLINE_ONLY / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | Repeat-exact [B0R/R0R](development/physical-sound-v44-b0r-r0r-corrected-baseline-result-2026-09-03.md) freezes global median `1.312187716` and the current `49`-parent planning deficit. [C1](development/physical-sound-v44-c1-runtime-descriptor-contract-result-2026-09-03.md), [G0A](development/physical-sound-v44-g0a-structured-source-increment-result-2026-09-03.md) and [G0B0](development/physical-sound-v44-g0b0-ieteasy-prospective-parent-result-2026-09-03.md) freeze descriptors and the `15/150` IETeasy catalogue. [G0B1a](development/physical-sound-v44-g0b1a-ieteasy-payload-target-probe-result-2026-09-03.md) verifies all `15/15` selected payload/media/onset/target paths. [G0B1b](development/physical-sound-v44-g0b1b-target-cap-normalization-audit-result-2026-09-03.md) now proves normalization exact under `0.5×/2×`, but rejects caps `12/24/48/96` against `138–225` reference peaks: even `96` passes only `9/15`. G0B1c must preregister a noise-robust fixed-size modal distribution before corpus materialization; current support remains unchanged and a second independent Steel project is still required before PSEL. Metadata-first V0S remains parallel; only B1, frozen V0, one-shot protected admission and deterministic cooking can authorize an opt-in prop, and every failure retains the authored fallback. |
