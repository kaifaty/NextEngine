...
| Physical sound source synthesis | SPEC-45 `Proposed`; Roadmap V12 targets `ACQUISITION_COVERAGE_CERTIFICATE / EXPLICIT_MODAL_TRANSFER / CONSTRAINED_OFFLINE_ML / INDEPENDENT_VALIDATOR / BAKED_CLIP_ATLAS`; current status `A1R_FORCE_ONSET_PASS / V9_REAL_FIT_REJECTED / B1R3_REPEAT_REJECTED / C1_REPEAT_PASS / C2_SOURCE_PASS / C3_REPEAT_PASS / C4A_PREFLIGHT_REPEAT_PASS / FIT_RUN_NEXT / FIT_ROLE_ONLY_AUTHORIZED / VALIDATOR_NOT_RELEASED / CLIP_FALLBACK / P1_BLOCKED`; no public schema, content role, runtime model or production gate promoted | Follow [Roadmap V12](plans/physical-sound-synthesis-roadmap-v12.md), the [C4a preflight result](development/physical-sound-r3a-v12-c4a-real-frf-runner-preflight-result-2026-08-31.md), [C4a protocol](development/physical-sound-r3a-v12-c4-object41-real-frf-fit-protocol-2026-08-31.md), [C1 result](development/physical-sound-r3a-v12-c1-acquisition-coverage-oracle-result-2026-08-31.md) and [C3 result](development/physical-sound-r3a-v12-c3-object41-source-role-freeze-result-2026-08-31.md). C1 recovers `7/7` known poles with calibrated OOD; C2+C3 bind fresh `41 / Wrench_Large / Steel` to all `35` paired force/mic trials and six signal-blind roles. C4a runner and repeated zero-read preflight now pass byte-for-byte, opening only the exact sixteen-contact fit budget. Development, holdout, ML, validator release and runtime stay closed; production requires a concrete consumer and ADR-046 gate. |
