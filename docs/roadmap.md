...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V20](plans/physical-sound-synthesis-roadmap-v20.md) status `ADOPTED / R0_COMPLETE / M0A_REPEAT_EXACT_REJECT / M0B_PROTOCOL_FROZEN / M0B_IMPLEMENTATION_PENDING / P0C_BLOCKED_BY_M0B / I1_SEALED / SOURCE_GROWTH_PARALLEL / ADMISSION_BLOCKED / CLIP_FALLBACK / P1_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [M0a](development/physical-sound-v20-m0-phase-consistent-metric-result-2026-09-01.md) passes deterministic, hard, physical, transient and monotonic controls twice exactly but rejects raw-log frequency margin and absolute decay energy because accepted modal gains confound both. [M0b](development/physical-sound-v20-m0b-confound-resistant-metric-protocol-2026-09-01.md) freezes centered log-spectral shape and normalized decay slope on the same opened development identities before fresh `1701…1712` integration. [S0c](development/physical-sound-v15-s0c-source-sufficiency-role-freeze-result-2026-09-01.md) independently keeps real admission blocked under unchanged `4/1/1/1/1`; authored clips remain complete fallback. |
