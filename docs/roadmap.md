...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1 and PS-2 plan/pilot/acquisition bundle `IMPLEMENTED`; current status `PS-2_ACQUISITION_CONTRACT_COMPLETE / PS-2_CAPTURE_BLOCKED_ON_FORCE_HARDWARE / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md): exact axes, risk policy and complete raw synchronized microphone/force/metrology bundle are executable. One 48 kHz REALIMPACT transfer correctly falls back and a complete control is only research-eligible. The host exposes ordinary ALC1220 mic/line capture but no identified calibrated force/hammer channel; microphone-only capture gets no credit. Connect synchronized force hardware or supply a complete bundle, then scale to 40 objects, 35 reject parents and 16 coverage groups before PS-3/AV-P0D. R&D remains PresentationOnly and non-blocking for R7; production P1 gates remain unchanged. |
