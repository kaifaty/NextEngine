...
| Physical sound source synthesis | SPEC-45 `Proposed`; Roadmap V12 targets `ACQUISITION_COVERAGE_CERTIFICATE / EXPLICIT_MODAL_TRANSFER / CONSTRAINED_OFFLINE_ML / INDEPENDENT_VALIDATOR / BAKED_CLIP_ATLAS`; current status `A1R_FORCE_ONSET_PASS / V9_REAL_FIT_REJECTED / B1R3_REPEAT_REJECTED / C1_REPEAT_PASS / C2_SOURCE_PASS / C3_RUNNER_IMPLEMENTED / C3_EVIDENCE_NEXT / REAL_PCM_CLOSED / VALIDATOR_NOT_RELEASED / CLIP_FALLBACK / P1_BLOCKED`; no public schema, content role, runtime model or production gate promoted | Follow [Roadmap V12](plans/physical-sound-synthesis-roadmap-v12.md), the [C1 result](development/physical-sound-r3a-v12-c1-acquisition-coverage-oracle-result-2026-08-31.md), [C2 inventory](development/physical-sound-r3a-v12-c2-internet-source-zero-decode-inventory-2026-08-31.md) and [C3 protocol](development/physical-sound-r3a-v12-c3-object41-source-role-freeze-protocol-2026-08-31.md). C1 recovers `7/7` known poles at `0.004961` holdout mean NRMSE with calibrated OOD. C2 proves a stable paired source with narrowed canonical-setup/instrument-count semantics. C3 targets fresh object `41 / Wrench_Large / Steel`, 35 contacts, six signal-blind roles and a hard `4 GiB` stop; bounded importer and focused tests are implemented, freeze/preflight/inventory evidence is next, and PCM remains closed. ML, validator release and runtime stay closed; production requires a concrete consumer and ADR-046 gate. |
