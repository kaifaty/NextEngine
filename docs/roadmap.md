...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V28](plans/physical-sound-synthesis-roadmap-v28.md) status `ADOPTED / H0_COMPLETE / R0_FROZEN / R1_REPEAT_EXACT_RESOURCE_PASS / R2_OFFICIAL_NEXT / Q0_SIGNAL_BLIND_READY / M0B_SPENT`; no public schema, content role, runtime model or production gate promoted | [R1](development/physical-sound-v28-r1-m0c-owner-resource-result-2026-09-02.md) passes exact prefix/full-entry gates and two isolated 10,000-step runs at `164.616/155.428 s`, `~1.01 GB`, normalized SHA `078ff403…6af6`; no official/model/loss value opened. Fresh official M0c A/B is next; Q0 validator inventory may proceed independently. Metal admission, cooker/demo and Glass/Wood remain blocked; authored fallback stays authoritative. |
