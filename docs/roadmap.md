...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive/Ogg/RAR5 handling, eight E3 project sources, explicit target/reject-parent roles, five frozen REALIMPACT E2 rows, split-feasibility, deterministic split verification and exact-domain E2/E3 claim matrix `IMPLEMENTED`; current status `PS-2_DOMAIN_CLAIM_MATRIX_EXECUTABLE / PROJECT_SPLIT_FROZEN / ONE_CROSS_TIER_LINK / EIGHT_EXACT_CLAIMS_OPEN / FALLBACK_OUT_OF_DOMAIN / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md) and [exact-domain matrix evidence](development/physical-sound-domain-claims-matrix-ps2-2026-08-28.md). Local capture is retired. Eight E3 projects validate 64 objects/135 recordings; Glass is 16/16 and 46 recordings, reject parents 48/35 and 89. The verified `2/2/2/2` project split gives every partition both roles. The new fail-closed matrix hash-links that split to five REALIMPACT E2 reports and admits only the reviewed Blue Bowl object 6 bridge. It confirms real identity, E3 repeats and one force-deconvolved transfer, but rejects exact-domain closure: composition revision, planned geometry/support/excitation/impact/listener alignment, matched-condition lineage and four-partition eligible coverage are absent. Next test published-source feasibility for those claims; if the acquisition-shaped V1 domain has no online path, preregister an internet-native revision rather than invent metadata. `Pass`, PS-3 and AV-P0D remain disabled; R&D stays PresentationOnly and production P1 gates are unchanged. |
