...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V37](plans/physical-sound-synthesis-roadmap-v37.md) is `ACTIVE / R0_N0_COMPLETE / V36_D0_REPEAT_EXACT_METRIC_REJECT / V36_CLOSED / H0_UNOPENED / NR_NEXT / ML_FIRST / AUTOMATIC_VALIDATION / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | [V36 D0](development/physical-sound-v36-d0-fresh-development-result-2026-09-03.md) repeats exactly across both official processes: all hard/resource gates pass, but the candidate fails 18/28 metric/ablation gates and contact is `2.394927x` nearest, so H0 stays unopened and compact hybrid ML closes. V37 next researches a topology/surface operator with explicit query interaction and unambiguous reject/freeze evidence. The independent source lane remains six exact-Steel and 27 non-Metal groups short. |
