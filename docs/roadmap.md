...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V21](plans/physical-sound-synthesis-roadmap-v21.md) status `ADOPTED / V20_I1_REPEAT_EXACT_REJECT / ACTUAL_ACOUSTIC_PASS / P0D_OPEN / F1_VALUES_SEALED / SOURCE_GROWTH_PARALLEL / ADMISSION_BLOCKED / CLIP_FALLBACK / P2_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [I1](development/physical-sound-v20-i1-frozen-integration-result-2026-09-01.md) repeats byte-exactly: all four actual acoustic gates and global/absolute field quality pass, but one Wood/Bowl remesh drift gate and one P0c counterfactual-owner defect reject the revision. [V21 research](development/physical-sound-v21-remesh-consistency-research-2026-09-01.md) selects a bounded continuous-residual F1 tournament on sealed paired `1801…2101`; [S0c](development/physical-sound-v15-s0c-source-sufficiency-role-freeze-result-2026-09-01.md) independently keeps real admission blocked under unchanged `4/1/1/1/1`; authored clips remain complete fallback. |
