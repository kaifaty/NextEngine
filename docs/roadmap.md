...
7. **R5 humanoid movement TRAIN-4 clip-global prototype (`ACTIVE_R&D / CURRENT WIP`):**
   ...
   R86 bounds the re-solve radius and R87 confirms exact improvement; R88 tests
   one unchanged-trust continuation. До unchanged all-three
