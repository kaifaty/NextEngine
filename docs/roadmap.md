...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache, AV-MSF E3 normalization/coverage and one frozen REALIMPACT typed E2 adapter `IMPLEMENTED`; current status `PS-2_REALIMPACT_E2_ADAPTER_READY / INDEPENDENT_E3_AND_REPLAN_NEXT / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md), [source/cache evidence](development/physical-sound-internet-source-pipeline-ps2-2026-08-27.md), [AV-MSF multi-object E3 pilot](development/physical-sound-av-msf-e3-multiobject-pilot-ps2-2026-08-27.md) and [REALIMPACT E2 adapter](development/physical-sound-realimpact-e2-adapter-ps2-2026-08-27.md): local capture is retired. One exact REALIMPACT row now has typed transfer/geometry/position evidence but remains fallback; AV-MSF validates 10 objects/20 recordings in one project group and Glass stays 2/16. Add independent published E3 sources, then re-plan at least 35 reject parents and 16 in-domain groups before PS-3/AV-P0D. Insufficient published evidence remains fallback-only; R&D stays PresentationOnly and production P1 gates are unchanged. |
