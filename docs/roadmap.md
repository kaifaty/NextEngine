...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive/Ogg/RAR5 handling, eight E3 project sources, explicit target/reject-parent roles, five frozen REALIMPACT E2 rows, split-feasibility and deterministic split-freeze verification `IMPLEMENTED`; current status `PS-2_PROJECT_SPLIT_FROZEN / GLASS_16_OF_16 / REJECT_PARENTS_48_OF_35 / FOUR_PARTITIONS_ROLE_COMPLETE / DOMAIN_AXIS_CLOSURE_OPEN / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md), prior linked E3/E2 evidence and the [Kronland reject plus split-freeze evidence](development/physical-sound-kronland-reject-split-freeze-ps2-2026-08-28.md). Local capture is retired. The typed Kronland expansion adds five Wood and five Metal original recordings without counting another project; independent online/offline and legacy reports repeat byte-identically. Eight E3 projects now validate 64 objects/135 recordings; Glass remains 16/16 and 46 recordings, while explicit reject parents reach 48/35 objects and 89 recordings. Four dual-role projects make the frozen `20/30/25/25` plan feasible. A seed-bound exact assignment and two post-split audits verify two whole projects plus both roles in each partition; `dev/calibration/holdout/shadow` contain `30/6/12/16` objects and `70/20/27/18` recordings. This closes split structure only: exact geometry/support/excitation/listener claim coverage, calibrated risk and sealed shadow evaluation remain open, so `Pass`, PS-3 and AV-P0D stay disabled. Five REALIMPACT rows remain fallback-only, bounded rejected source routes remain rejected, R&D stays PresentationOnly and production P1 gates are unchanged. |
