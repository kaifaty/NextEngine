...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V28](plans/physical-sound-synthesis-roadmap-v28.md) status `ADOPTED / R1_PASS / R2_REPEAT_EXACT_REPRESENTATION_REJECT / M0C_CLOSED / Q0_SIGNAL_BLIND_NEXT / GENERATOR_SUCCESSOR_REQUIRES_FRESH_RESEARCH`; no public schema, content role, runtime model or production gate promoted | [R2 A/B](development/physical-sound-v28-r2-official-feasibility-result-2026-09-02.md) match all six artifacts. Frequency/gain/spectrum improve over ridge, but decay ratio `1.924`, remesh `0.01156 > 1e-5` and physical intervention errors `0.49–3.00` close M0c before holdout/real access. Q0 validator freeze is next; a generator successor needs fresh research. Metal admission, cooker/demo and Glass/Wood remain blocked; authored fallback stays authoritative. |
