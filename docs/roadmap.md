...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V29](plans/physical-sound-synthesis-roadmap-v29.md) status `ADOPTED / V28_M0C_CLOSED / Q0M_SOURCE_IDENTITIES_FEASIBLE / Q1M_ROLE_POWER_FREEZE_NEXT / VALIDATOR_FIRST / CAUSAL_HYBRID_GENERATOR_RESEARCH / INTERNET_ONLY / AUTOMATIC_ADMISSION / CLIP_FALLBACK`; no public schema, content role, runtime model or production gate promoted | [Q0-M](development/physical-sound-v29-q0m-metal-source-inventory-result-2026-09-02.md) passes twice exactly with zero signal access: after 30 immutable Glass-split exclusions, 23 exact-Steel, 39 broad-Metal and 70 non-Metal identities remain across ObjectFolder and YCB. Q1-M must now prove freshness, effective cluster power and one-use roles; in parallel P0 may freeze one physics-locked modal-plus-learned-correction family. Metal training remains blocked until validator qualification and synthetic remesh/counterfactual truth pass; authored fallback stays authoritative. |
