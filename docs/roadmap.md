...
| Physical sound source synthesis | SPEC-45 `Proposed`; Roadmap V14 status `N0_REBASELINE_COMPLETE / N1_DATASET_CONTRACT_NEXT / MEASURED_TRANSFER_OPTIONAL_SOURCE_BLOCKED / CLIP_FALLBACK / P1_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [V14 research](development/physical-sound-v14-data-first-neural-rebaseline-2026-08-31.md) preserves the object-41/object-92 negatives but removes single perfect-source recovery from the sequential critical path. [Roadmap V14](plans/physical-sound-synthesis-roadmap-v14.md) next freezes a signal-blind multi-object Dataset Contract V1, then runs a known-truth neural oracle, exact-object few-shot tournament, cross-object authoring prior, independent validator and deterministic clip cooker. Raw-force transfer, runtime inference and production promotion remain separate blocked claims. |
