...
| Physical sound source synthesis | SPEC-45 `Proposed`; Roadmap V14 status `N1A_REPEAT_EXACT_PASS / N1B_METADATA_INVENTORY_NEXT / MEASURED_TRANSFER_OPTIONAL_SOURCE_BLOCKED / CLIP_FALLBACK / P1_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [N1a](development/physical-sound-v14-n1a-dataset-contract-v1-result-2026-09-01.md) freezes a repeat-exact zero-source Dataset Contract V1 with `4/1/1/1/1` Glass/Wood/Metal role minima, physical-object/recording-parent disjointness and prior-exposure guards. [Roadmap V14](plans/physical-sound-synthesis-roadmap-v14.md) next inventories real ObjectFolder/RealImpact/ObjectFolder-2.0 metadata and bounded acquisition cost without PCM/force decode; known-truth neural work remains blocked until N1 role freeze. Raw-force transfer, runtime inference and production promotion remain separate blocked claims. |
