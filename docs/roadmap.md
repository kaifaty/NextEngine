...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive/Ogg/RAR5 handling, eight E3 project sources, explicit target/reject-parent roles, five typed REALIMPACT E2 rows, exact-domain/source gates, V1/V2 transfer calibration, listener acquisition, narrow vertical holdout, fixed-RBF extension reject and bbox-conditioned calibration reject `IMPLEMENTED`; current status `PS-2_BBOX_CONDITIONED_BANDWIDTH_CALIBRATION_REJECTED / TWO_HOLDOUT_OBJECTS_PRESERVED / FREQUENCY_CONDITIONED_PREREGISTRATION_NEXT / THREE_DIMENSIONAL_SPATIAL_FIELD_OPEN / EIGHT_EXACT_CLAIMS_OPEN / FALLBACK_OUT_OF_DOMAIN / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md) and [shape-calibration evidence](development/physical-sound-realimpact-shape-spatial-calibration-ps2-2026-08-28.md). Local capture is retired. Transfer V1 remains invalid; injective V2 passes narrow modal/damping. The original RBF vertical pilot remains positive, but fixed RBF fails Blue/Glass. A fresh roster-derived 10/2/2 split then rejects one bbox/aspect/impact-conditioned object bandwidth: both calibration condition gates pass and p90 improves, while median ratio `1.0122` fails `0.95`. Do not retune either reject; both declared ceramic holdouts remain unopened. Next preregister a per-mode frequency/acoustic-scale-conditioned bandwidth on fresh calibration with per-object/clip fallback. All eight exact-domain blockers, 3D spatial credit, corpus admission, `Pass`, PS-3, AV-P0D and production P1 remain disabled. |
