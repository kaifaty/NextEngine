...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V25](plans/physical-sound-synthesis-roadmap-v25.md) status `ADOPTED / V24_EVIDENCE_PLANE_COMPLETE / M0_ONEHOT_CAUSAL_DEFECT / M0A_PROTOCOL_FROZEN / M0A_IMPLEMENTATION_IN_PROGRESS / MODEL_VALUES_UNOPENED / AUTOMATIC_VALIDATOR_REQUIRED / OFFLINE_COOKED_CLIPS / P3_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [D0](development/physical-sound-v24-d0-neural-evidence-plane-result-2026-09-01.md), [T0](development/physical-sound-v24-t0-analytic-teacher-result-2026-09-01.md) and [X0](development/physical-sound-v24-x0-blue-bowl-pilot-result-2026-09-01.md) pass twice exactly; their combined V3 record contains 151 honest-axis rows. [M0's conformance defect](development/physical-sound-v25-m0-implementation-conformance-rebaseline-2026-09-02.md) was found before values: one-hot material input could not expose isolated `E`/density gates. [M0a](development/physical-sound-v25-m0a-causal-material-neural-student-protocol-2026-09-02.md) freezes masked physical coordinates without guessing Glass constants. Next is full-entry M0a conformance, then one official A/B decision, independent validator, protected Metal admission, deterministic cooker and one fallback-safe demo prop. No user recording or per-sound human approval. |
