...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V24](plans/physical-sound-synthesis-roadmap-v24.md) status `ADOPTED / V23_IMPLEMENTATION_REJECT / QUALITY_UNOBSERVED / D0_PROTOCOL_FROZEN / D0_IMPLEMENTATION_NEXT / DATA_FIRST_ML / AUTOMATED_VALIDATOR_REQUIRED / CLIP_FALLBACK / P3_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [V23 F2a](development/physical-sound-v23-f2a-fixed-feature-ridge-result-2026-09-01.md) closed without quality. [V24 D0](development/physical-sound-v24-d0-neural-evidence-plane-protocol-2026-09-01.md) now freezes a compatible V3 of the existing neural data plane with explicit synthetic-teacher, exact-real-transfer and identified-real-recording lanes, teacher-target references, unchanged five-role sealing and a twice-executed full `run_cli` fixture. T0/X0/model values remain unopened; no user recording or per-sound human approval. |
