...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive/Ogg/RAR5 handling, eight E3 project sources, explicit target/reject-parent roles, five typed REALIMPACT E2 rows, exact-domain/source gates, V1/V2 transfer calibration, listener acquisition, spatial-representation rejection chain, analytical boundary harness, independent Bempp controls, a spherical quadrupole cooker and triaxial full-angular near-to-far cooker `IMPLEMENTED`; current status `PS-2_TRIAXIAL_FULL_SHELL_COOKER_SUPPORTED / SPARSE_ANGULAR_INTERPOLATION_REJECTED / BYTE_IDENTICAL_REPEATS / NO_FRESH_DATA_OPENED / TWO_HOLDOUT_OBJECTS_PRESERVED / FEM_EIGENMODE_COUPLING_NEXT / REAL_3D_FIELD_OPEN / EIGHT_EXACT_CLAIMS_OPEN / FALLBACK_OUT_OF_DOMAIN / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md) and [triaxial/full-angular evidence](development/physical-sound-bempp-triaxial-full-angular-cooker-ps2-2026-08-28.md). Local capture is retired. Triaxial Bempp levels `128/512/2048` pass all frozen convergence/field gates and repeat at `49bee8c2…76ef`. Sparse near-angle interpolation remains rejected at `6d5f653a…ef55`; a separately frozen full-near-shell protocol rejects `m=0`, selects full degree 2 and predicts 224 held `4L/10L` conditions with `4.6045%` maximum error and `0.9990417` minimum correlation, repeating at `a0e0d881…b0be`. Credit is synthetic prescribed-mode representation only. Open no fresh data. Next couple one actual elastic FEM eigenmode. All eight exact-domain blockers, real 3D spatial credit, corpus admission, `Pass`, PS-3, AV-P0D and production P1 remain disabled. |
