...
| R8. Post-v1 tracks | `IN_PROGRESS / R8B_FIRST_LEARNED_LOCOMOTION_SELECTED / WALKING_RESEARCH_REQUIRED` | отдельные программы | R8a closes the bounded intact-topology condition/capability subset. R8b standing passes; walking V1/V2/V3 are rejected for no meaningful canonical travel. Further walking optimizer work is stopped pending bounded gait/contact/action and mirror research. Other optional tracks remain gated. |
...
R&D_ONLY_WALKING_V1_V2_V3_FAILED / WALKING_RESEARCH_REQUIRED /
...
Further optimizer work is stopped until bounded research discriminates missing
gait/contact curriculum, action/observation limitations and mirror dynamics.
R8b remains a
...
3. learned forward start/stop checkpoint: only the fixed V2 command lesson
   with the V3 dense reward (`0.5 m/s`, no strafe/yaw/backward) is in scope;
   each admitted
...
| PhysX deterministic humanoid substrate | ADR-058/059/062/063/064/065/067/069/071/100/101/102/103/104/105 `Accepted`; biomechanics V3/standing V2 passes its nominal GPU/CPU standing gate; walking V1/V2/V3 are rejected; paired V3 `MODEL-MIRROR-P1` fails fixed joint/root-velocity bounds | Stop optimizer work and run the bounded post-failure gait/contact/action and mirror research cycle. Broader curriculum and runtime promotion remain blocked until the full CPU quality/correspondence matrix passes. |
...
V3_STANDING_NOMINAL_GATE_PASS / R&D_ONLY_WALKING_V1_FAILED /
WALKING_V2_AUTHORIZED / MODEL_MIRROR_P1_FAILED / NO_RUNTIME_AUTHORITY`)**. Its durable
resume surface is
...
episodes. Further optimizer work stops for bounded post-failure research. The
ceiling remains `NO_AUTHORITY`, and mirror repair remains an independent
promotion gate. R8a fracture and embodiment
