...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V26](plans/physical-sound-synthesis-roadmap-v26.md) status `ADOPTED / M0A_E_PREPROCESS_CONFORMANCE_REJECT / NO_MODEL_VALUES_OPENED / P0_ALIGNMENT_DEFECT / P0A_PROTOCOL_FROZEN / I0_NEXT / AUTOMATIC_VALIDATOR_REQUIRED / OFFLINE_COOKED_CLIPS / P3_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [M0a-E](development/physical-sound-v25-m0a-official-evaluation-result-2026-09-02.md) stopped before model construction because a valid official impact was not a coarse-mesh vertex. P0 barycentric smoke repaired that row, then [complete-preprocessing conformance](development/physical-sound-v26-p0-implementation-conformance-rebaseline-2026-09-02.md) proved three legal context peaks require bounded leading padding to reach anchor `512`. [P0a](development/physical-sound-v26-p0a-barycentric-and-padded-alignment-protocol-2026-09-02.md) freezes that zero-padding correction at `54522c26…49e8` without changing model, seed, losses, schedule, roles or gates. Next is I0 with surface/alignment fixtures, one M0b A/B decision, independent validator, protected Metal admission, deterministic cooker and one fallback-safe demo prop. No user recording or per-sound human approval. |
