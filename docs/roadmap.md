...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive/Ogg/RAR5 handling, eight E3 project sources, explicit target/reject-parent roles, five frozen REALIMPACT E2 rows, deterministic split, exact-domain/source gates, V1/V2 transfer calibration, exact listener acquisition, narrow vertical holdout and two-object axis-stratified rejection `IMPLEMENTED`; current status `PS-2_FIXED_RBF_MULTIOBJECT_AXIS_REJECTED / NARROW_VERTICAL_PILOT_RETAINED / SHAPE_CONDITIONED_PREREGISTRATION_NEXT / THREE_DIMENSIONAL_SPATIAL_FIELD_OPEN / EIGHT_EXACT_CLAIMS_OPEN / FALLBACK_OUT_OF_DOMAIN / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md) and [multi-object extension evidence](development/physical-sound-realimpact-spatial-extension-ps2-2026-08-28.md). Local capture is retired. Eight E3 projects validate 64 objects/135 recordings; Glass is 16/16 and 46 recordings, reject parents 48/35 and 89. Transfer V1 remains invalid; injective V2 passes narrow modal/damping. The original RBF vertical pilot remains positive, but its frozen extension fails: Glass passes `4/6` condition blocks, Blue `3/6` and the required Blue base block fails. Preserve the negative holdout and do not tune on Blue/Glass. Next inventory fresh official objects and preregister coordinate-only control versus one shape-conditioned spatial model with per-object/clip fallback. All eight exact-domain blockers, 3D spatial credit, corpus admission, `Pass`, PS-3, AV-P0D and production P1 remain disabled. |
