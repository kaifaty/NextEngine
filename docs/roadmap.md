...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import bundle, internet source registry/cache/capability audit and first AV-MSF real E3 adapter `IMPLEMENTED`; current status `PS-2_FIRST_E3_SOURCE_READY / GROUPED_CORPUS_EXPANSION_NEXT / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md), [source/cache evidence](development/physical-sound-internet-source-pipeline-ps2-2026-08-27.md) and [AV-MSF E3 pilot](development/physical-sound-av-msf-e3-pilot-ps2-2026-08-27.md): user/local physical capture is retired and force hardware is not a blocker. Bounded HTTPS fetch, external content-addressed cache and artifact-backed `E1`–`E4` accounting fail closed. One AV-MSF glass object/two recordings are E3-ready; this one group has no admission credit. Normalize multiple independent E3 groups and implement the bounded REALIMPACT E2 adapter, then re-plan coverage for at least 35 reject parents and 16 in-domain groups before PS-3/AV-P0D; insufficient published evidence remains fallback-only. R&D stays PresentationOnly and non-blocking for R7; production P1 gates are unchanged. |
