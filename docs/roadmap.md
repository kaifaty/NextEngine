...
| Local continuum materials: water, deformable terrain, mud and off-road coupling | `SOURCE_LINE_STOPPED / FORMULA_RECLOSURE_ACTIVE / INTEGRATION_BLOCKED`; SPEC-38/ADR-076 `Proposed`; water W1 `LINUX_W1_PASS / CONTINUUM-WATER-REF-P1=PASS` at `fe223f9`; CPU/direct-GPU W2 miss; source-shaped Nonlocal standalone performance passes but NPR1-B physical formula consistency fails; separate `nuv-variational-fcr1` FCR0 is specified and later ProductChecks remain `NOT_RUN` | W0F/G/H/I roots remain frozen and W3 remains blocked. [The performance decision](development/nonlocal-continuum-performance-decision-2026-08-20.md) remains valid only for the exact source-shaped laboratory arithmetic and grants no W2 credit. NPR0 selected one h3/16 report-only profile, NPR1-A closed isolated canonical publication, then the independent [NPR1-B discriminator](development/nonlocal-continuum-npr1b-term-controls-evidence-2026-08-20.md) stopped that exact [productionization line](plans/nonlocal-continuum-production/README.md). A separately rooted [formula-reclosure roadmap](plans/nonlocal-continuum-formula-reclosure/README.md) now restarts algebra, coefficient/profile, physics, CUDA and performance closure without inheriting v4 roots or authority. No GPU authority, integration or public contract changes follow. DFSPH remains the water correctness reference; independent terrain closure remains Package 10T. |
