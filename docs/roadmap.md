...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V44](plans/physical-sound-synthesis-roadmap-v44.md) is `ACTIVE / B0R_R0R_COMPLETE / C1_COMPLETE / G0A_COMPLETE / G0B0_IETEASY_PROSPECTIVE_COMPLETE / 15_PROSPECTIVE_PARENTS / 150_HASHED_WAVEFORMS / 5_STEEL_PARENTS / ZERO_DESCRIPTOR_COMPLETE / G0B1_NEXT / PSEL_BLOCKED / V0S_OPEN / V0_BLOCKED_BY_POWER / TRAINING_BLOCKED / OFFLINE_ONLY / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | Repeat-exact [B0R/R0R](development/physical-sound-v44-b0r-r0r-corrected-baseline-result-2026-09-03.md) freezes global median `1.312187716` and the current `49`-parent planning deficit. Repeat-exact [C1](development/physical-sound-v44-c1-runtime-descriptor-contract-result-2026-09-03.md) freezes nine runtime descriptor axes; [G0A](development/physical-sound-v44-g0a-structured-source-increment-result-2026-09-03.md) adds YCB mass/extents and numerical plate controls. [G0B0](development/physical-sound-v44-g0b0-ieteasy-prospective-parent-result-2026-09-03.md) now freezes separate catalogue/materialization/PSEL eligibility and binds `15` IETeasy physical specimens to `150` publisher-hashed waveforms, including five prospective Steel parents, without downloading payload. Prospective rows do not reduce current support: G0B1 must hash-verify media, materialize disclosed targets and add at least a second independent Steel project before signal-blind PSEL. Metadata-first V0S remains parallel; only B1, frozen V0, one-shot protected admission and deterministic cooking can authorize an opt-in prop, and every failure retains the authored fallback. |
