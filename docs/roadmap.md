...
| PhysX deterministic humanoid substrate | ADR-058/059/062/063/064/065/067/069/071/100/101/102/103/104/105/106 `Accepted`; V3 nominal standing passes; walking V1/V2/V3 are rejected; V4/V5 action/proxy diagnostics implemented, CPU bilateral reachability passes but exact-tape Isaac GPU/CPU safety and correspondence fail | Localize first physical divergence before optimizer work. The original within-episode alternation and MODEL-MIRROR gates remain open; diagnostic single swings grant no learned quality. |
