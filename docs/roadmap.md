...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive/Ogg/RAR5 handling, eight E3 project sources, explicit target/reject-parent roles, five frozen REALIMPACT E2 rows, deterministic split, exact-domain/source gates, V1/V2 transfer calibration and one exact 15-listener development block `IMPLEMENTED`; current status `PS-2_MULTILISTENER_DEV_BLOCK_VERIFIED / TRANSFER_V2_MODAL_DAMPING_HOLDOUT_PASS / SPATIAL_MODEL_NOT_EVALUATED / MULTIOBJECT_PREREGISTRATION_NEXT / EIGHT_EXACT_CLAIMS_OPEN / FALLBACK_OUT_OF_DOMAIN / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md) and [multi-listener evidence](development/physical-sound-realimpact-multilistener-acquisition-ps2-2026-08-28.md). Local capture is retired. Eight E3 projects validate 64 objects/135 recordings; Glass is 16/16 and 46 recordings, reject parents 48/35 and 89. Transfer V1 remains invalid; injective V2 passes its narrow modal/damping holdout. Two bounded Green Goblet runs now prove rows `0..14` are distinct listeners for one exact impact block, but no spatial model, calibration or holdout has run. Next preregister the Green Goblet/Shell Plate/Skull Cup split, candidates, metrics, gates and archive ranges before opening more listener rows. All eight exact-domain blockers, corpus admission, `Pass`, PS-3, AV-P0D and production P1 remain disabled. |
