...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V37](plans/physical-sound-synthesis-roadmap-v37.md) is `ACTIVE / R0_N0_NR_RESEARCH_COMPLETE / QSO_V0_SELECTED / A0_F0_REPEAT_EXACT_PASS / C0_NEXT / V36_CLOSED / H0_UNOPENED / ML_FIRST / AUTOMATIC_VALIDATION / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | [V36 D0](development/physical-sound-v36-d0-fresh-development-result-2026-09-03.md) closes scalar-hybrid contact transfer. Corrected [QSO A0](development/physical-sound-v37-a0-query-surface-contract-result-2026-09-03.md) freezes typed containers and `Pass`-only authority; [F0](development/physical-sound-v37-f0-fresh-query-surface-operator-result-2026-09-03.md) repeat-exactly freezes 1,512 fresh cases, three operator truth components and eight comparisons with zero target/truth/model/official access. C0 next proves full-shape structure, remesh/reachability and cost using artificial zeros. The independent source lane remains six exact-Steel and 27 non-Metal groups short. |
