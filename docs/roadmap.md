...
| Navigation/audio | Частично: neutral `NeutralAudioV1` clip contract + cook/activation plumbing (baseline audio A1) | Нет runtime audio scene/mixer service, device adapter, navigation cooker и baseline adapters. |
