...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V32](plans/physical-sound-synthesis-roadmap-v32.md) status `ADOPTED / P0_P1_T0_COMPLETE / V0_V1_CLEAN_FALSE_POSITIVE_REJECT / V0A_PROTOCOL_FROZEN / V0A_IMPLEMENTATION_NEXT / VALIDATOR_FIRST / BOUNDED_SOURCE_SCOUTING / REAL_RELEASE_BLOCKED_BY_SOURCE_POWER / OFFLINE_ML_ONLY / NO_PER_SOUND_HUMAN_REVIEW / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | [V0-v1](development/physical-sound-v32-v0-validator-mechanics-result-2026-09-02.md) atomically rejects because target-ID-only retrieval misclassifies two exact clean causal alias classes. The [V0a protocol](development/physical-sound-v32-v0a-modal-equivalence-validator-protocol-2026-09-02.md) freezes modal-equivalence-aware retrieval while retaining plate→beam copy rejection; all other V0 mechanics remain unchanged. [T0](development/physical-sound-v32-t0-truth-mutation-result-2026-09-02.md) stays exact, and [E2](development/physical-sound-v30-e2-q1a-source-growth-result-2026-09-02.md) still leaves the weaker role six exact-Steel and 27 non-Metal groups short; real calibration, training, admission and cooking remain sealed. |
