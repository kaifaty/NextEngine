...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V26](plans/physical-sound-synthesis-roadmap-v26.md) status `ADOPTED / M0A_E_PREPROCESS_CONFORMANCE_REJECT / NO_MODEL_VALUES_OPENED / P0_PROTOCOL_FROZEN / I0_NEXT / AUTOMATIC_VALIDATOR_REQUIRED / OFFLINE_COOKED_CLIPS / P3_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [M0a-E](development/physical-sound-v25-m0a-official-evaluation-result-2026-09-02.md) stopped before model construction because a valid official impact was not a coarse-mesh vertex; run B was not started and no quality value opened. [P0](development/physical-sound-v26-p0-barycentric-surface-query-protocol-2026-09-02.md) freezes strict triangle membership, canonical tie-break and barycentric interpolation at `4fff3ebd…65e7`, without changing model, seed, losses, schedule, roles or gates. Next is I0 with a 48-query official-shape fixture, one execution-equivalent M0b A/B decision, independent validator, protected Metal admission, deterministic cooker and one fallback-safe demo prop. No user recording or per-sound human approval. |
