...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V35](plans/physical-sound-synthesis-roadmap-v35.md) is `ACTIVE / R0_COMPLETE / F0_NEXT / FRESH_ROLES_REQUIRED / REAL_RELEASE_BLOCKED / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | [V35 research](development/physical-sound-v35-geometry-conditioned-hybrid-research-2026-09-02.md) converts V34's isolated `1.756639x` geometry-only loss to nearest into one coverage-gated geometry/contact hybrid: unchanged P1 plus successful decay/gain heads, an explicit-geometry spectral expert, continuous local interpolator and target-free support-distance gate. F0 must freeze fresh roles, truth, controls and anti-leakage before any new target. Synthetic H0 and the independent real source/validator lane must both pass before Steel training; [E2](development/physical-sound-v30-e2-q1a-source-growth-result-2026-09-02.md) still leaves the weaker real role six exact-Steel and 27 non-Metal groups short. |
