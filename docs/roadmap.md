...
| Physical sound source synthesis | SPEC-45 `Proposed`; PS-2 internet evidence, synthetic FEM→Bempp/full-angular controls, repeated Pitcher/Ceramic rejections and source-derived salience control `IMPLEMENTED`; current status `PS-2_PITCHER_COMBINED_PROTOCOL_REJECTED / CERAMIC_METHOD_DEVELOPMENT_CLOSED / IRON_SKILLET_METHOD_TRANSFER_REJECTED / SALIENCE_SELECTOR_REAL_TRANSFER_REJECTED / SYNTHETIC_CONTROL_RETAINED / CURRENT_TOP16_DIAGNOSTIC_STRONGER / BOUNDED_METHOD_RESEARCH_REQUIRED / MECHANICS_BLOCKED / PLANTER_AUDIO_SEALED / AUTHORED_CLIP_FALLBACK / EIGHT_EXACT_CLAIMS_OPEN / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [subsystem roadmap](plans/physical-sound-synthesis-roadmap.md) and [Iron Skillet result](development/physical-sound-realimpact-iron-skillet-observation-result-ps2-2026-08-28.md). Repeated report `a9c4ae36…206d` fails persistence `0.35294` and adaptive-valid fraction `0.50`; diagnostic top-16 is `0.9375/0.9375` valid/decaying. Freeze bounded existing-block diagnostics and research multichannel transient modal estimation before another implementation. No new object, retry, mechanics or Planter. |
