...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V20](plans/physical-sound-synthesis-roadmap-v20.md) status `ADOPTED / R0_COMPLETE / M0A_REPEAT_EXACT_REJECT / M0B_REPEAT_EXACT_PASS / P0C_FROZEN / I1_IMPLEMENTATION_PENDING / VALUES_SEALED / SOURCE_GROWTH_PARALLEL / ADMISSION_BLOCKED / CLIP_FALLBACK / P1_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [M0b](development/physical-sound-v20-m0b-confound-resistant-metric-result-2026-09-01.md) passes every centered-log, normalized-decay-slope, physical, monotonic, access and repeat gate twice exactly. [P0c](development/physical-sound-v20-p0c-i1-integration-protocol-2026-09-01.md) freezes fresh `1701…1712` metadata, midpoint thresholds, counterfactuals and fallback before I1 code may generate a value. [S0c](development/physical-sound-v15-s0c-source-sufficiency-role-freeze-result-2026-09-01.md) independently keeps real admission blocked under unchanged `4/1/1/1/1`; authored clips remain complete fallback. |
