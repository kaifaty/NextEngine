...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V44](plans/physical-sound-synthesis-roadmap-v44.md) is `ACTIVE / B0R_R0R_COMPLETE / C1_COMPLETE / G0A_COMPLETE / G0B0_COMPLETE / G0B1A_PAYLOAD_MEDIA_ONSET_COMPLETE / 15_OF_15_HASH_VERIFIED / TARGET_EXTRACTOR_AUDIT_REQUIRED / CORPUS_CREDIT_ZERO / 5_STEEL_PARENTS / ZERO_DESCRIPTOR_COMPLETE / G0B1B_NEXT / PSEL_BLOCKED / V0S_OPEN / V0_BLOCKED_BY_POWER / TRAINING_BLOCKED / OFFLINE_ONLY / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | Repeat-exact [B0R/R0R](development/physical-sound-v44-b0r-r0r-corrected-baseline-result-2026-09-03.md) freezes global median `1.312187716` and the current `49`-parent planning deficit. Repeat-exact [C1](development/physical-sound-v44-c1-runtime-descriptor-contract-result-2026-09-03.md) freezes nine runtime descriptor axes; [G0A](development/physical-sound-v44-g0a-structured-source-increment-result-2026-09-03.md) adds YCB mass/extents and numerical plate controls. [G0B0](development/physical-sound-v44-g0b0-ieteasy-prospective-parent-result-2026-09-03.md) binds `15` IETeasy specimens to `150` publisher hashes. [G0B1a](development/physical-sound-v44-g0b1a-ieteasy-payload-target-probe-result-2026-09-03.md) now freezes a signal-blind one-record-per-parent subset and repeat-exactly verifies all `15/15` payload, mono/48 kHz media, onset, complete C0 windows and target-extraction paths. All targets saturate the frozen 12-mode cap, so G0B1b must audit the extractor/overshoot policy before corpus materialization; current support remains unchanged and a second independent Steel project is still required before PSEL. Metadata-first V0S remains parallel; only B1, frozen V0, one-shot protected admission and deterministic cooking can authorize an opt-in prop, and every failure retains the authored fallback. |
