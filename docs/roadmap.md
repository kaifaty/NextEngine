...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive/Ogg handling, AV-MSF + YCB + Heller + two Freesound + ObjectFolder-Real-demo E3 project sources, declarative Freesound import, explicit target/reject-parent roles, one typed REALIMPACT adapter with four frozen E2 object rows including one same-object E2/E3 anchor and one distinct shell geometry, and bounded Greatest Hits/large-ObjectFolder-archive/direct-fetch rejections `IMPLEMENTED`; current status `PS-2_DISTINCT_SHELL_E2_READY / SIX_E3_PROJECT_GROUPS / GLASS_9_OF_16 / REJECT_PARENTS_38_OF_35 / FOUR_REALIMPACT_E2_OBJECTS / GLASS_AND_E2_EXPANSION_NEXT / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md), [source/cache evidence](development/physical-sound-internet-source-pipeline-ps2-2026-08-27.md), [AV-MSF multi-object E3 pilot](development/physical-sound-av-msf-e3-multiobject-pilot-ps2-2026-08-27.md), [independent YCB E3 pilot](development/physical-sound-ycb-independent-e3-pilot-ps2-2026-08-27.md), [independent Heller E3 pilot](development/physical-sound-heller-independent-e3-pilot-ps2-2026-08-27.md), [Greatest Hits discriminator](development/physical-sound-greatest-hits-discriminator-ps2-2026-08-27.md), [REALIMPACT E2 adapter](development/physical-sound-realimpact-e2-adapter-ps2-2026-08-27.md), [GreenGoblet bounded-range E2 pilot](development/physical-sound-realimpact-green-goblet-range-pilot-ps2-2026-08-27.md), [ObjectFolder/Freesound bowl E3 pilot](development/physical-sound-freesound-glass-bowl-e3-pilot-ps2-2026-08-28.md), [Freesound wine-glass cached E3 increment](development/physical-sound-freesound-wine-glass-e3-pilot-ps2-2026-08-28.md), [explicit reject-parent import](development/physical-sound-explicit-reject-parent-import-ps2-2026-08-28.md), [declarative Freesound adapter](development/physical-sound-declarative-freesound-adapter-ps2-2026-08-28.md), [ObjectFolder-Real interactive-demo E3 pilot](development/physical-sound-objectfolder-real-demo-e3-pilot-ps2-2026-08-28.md), [YCB vertical reject-parent expansion](development/physical-sound-ycb-vertical-reject-expansion-ps2-2026-08-28.md), [REALIMPACT Blue Bowl cross-tier E2 increment](development/physical-sound-realimpact-blue-bowl-cross-tier-ps2-2026-08-28.md) and [REALIMPACT Shell Plate bounded-range E2 pilot](development/physical-sound-realimpact-shell-plate-range-pilot-ps2-2026-08-28.md): local capture is retired. Four exact REALIMPACT rows remain fallback-only; object 6 is cross-tier with the existing ObjectFolder E3 group and object 51 adds a distinct broad shell transfer without E3 credit. Six E3 projects validate 47 objects/113 recordings; Glass is 9/16 and 34 recordings. Explicit roles identify 38/35 development-only non-Glass parents; the count minimum is met but creates no negative-control or false-pass credit, and all splits beyond `dev` remain closed. The huge ObjectFolder gzip and horizontally aggregated non-Glass YCB routes remain rejected. Next acquire 7 Glass target groups plus complementary E2/E1 evidence; `60_SkullCup` is the next bounded E2 candidate only when no new exact E3 route exists. Freeze calibration/holdout/shadow or start PS-3/AV-P0D only after the complete evidence minimum. Insufficient published evidence remains fallback-only; R&D stays PresentationOnly and production P1 gates are unchanged. |
