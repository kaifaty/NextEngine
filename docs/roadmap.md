...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V44](plans/physical-sound-synthesis-roadmap-v44.md) is `ACTIVE / B0R_R0R_C1_G0A_G0B0_COMPLETE / G0B1A_G0B1B_G0B1C0_COMPLETE / G0B1C1_CORPUS_MATERIALIZED / 15_TRAIN_INCREMENT / 71_SUPPORTED_PARENTS / DEFICIT_34 / 5_STEEL_PARENTS / ONE_IETEASY_PROJECT / SECOND_PROJECT_NEXT / PSEL_BLOCKED / V0S_OPEN / V0_BLOCKED_BY_POWER / TRAINING_BLOCKED / OFFLINE_ONLY / AUTHORED_FALLBACK`; no public schema, runtime model or production gate promoted | Repeat-exact [B0R/R0R](development/physical-sound-v44-b0r-r0r-corrected-baseline-result-2026-09-03.md) freezes global median `1.312187716` and the original `49`-parent planning deficit. [C1](development/physical-sound-v44-c1-runtime-descriptor-contract-result-2026-09-03.md), [G0A](development/physical-sound-v44-g0a-structured-source-increment-result-2026-09-03.md) and [G0B0](development/physical-sound-v44-g0b0-ieteasy-prospective-parent-result-2026-09-03.md) freeze descriptors and the `15/150` IETeasy catalogue. [G0B1a](development/physical-sound-v44-g0b1a-ieteasy-payload-target-probe-result-2026-09-03.md) verifies all payload/media paths, [G0B1b](development/physical-sound-v44-g0b1b-target-cap-normalization-audit-result-2026-09-03.md) rejects arbitrary mode caps and [G0B1c0](development/physical-sound-v44-g0b1c0-noise-robust-target-synthetic-result-2026-09-03.md) admits a fixed 75-value tonal/residual target on synthetic controls. [G0B1c1](development/physical-sound-v44-g0b1c1-ieteasy-corpus-increment-result-2026-09-03.md) now applies it unchanged and repeat-exactly materializes 15 parents/30 objects in one train increment; planning support is 71 and deficit 34. Because all five new Steel parents still come from one IETeasy project, a second independent descriptor-to-signal project remains mandatory before PSEL. Metadata-first V0S stays parallel; only B1, frozen V0, one-shot protected admission and deterministic cooking can authorize an opt-in prop, and every failure retains the authored fallback. |
