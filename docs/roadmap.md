...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V44](plans/physical-sound-synthesis-roadmap-v44.md) is `ACTIVE / B0R_R0R_C1_G0A_G0B0_COMPLETE / G0B1A_PAYLOAD_PASS / G0B1B_TARGET_AUDIT_COMPLETE / G0B1C0_SYNTHETIC_TARGET_ADMITTED / 75_DIMENSION_FIXED / IETEASY_TARGET_ACCESS_AUTHORIZED / CORPUS_CREDIT_ZERO / 5_STEEL_PARENTS / ZERO_DESCRIPTOR_COMPLETE / G0B1C1_NEXT / PSEL_BLOCKED / V0S_OPEN / V0_BLOCKED_BY_POWER / TRAINING_BLOCKED / OFFLINE_ONLY / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | Repeat-exact [B0R/R0R](development/physical-sound-v44-b0r-r0r-corrected-baseline-result-2026-09-03.md) freezes global median `1.312187716` and the current `49`-parent planning deficit. [C1](development/physical-sound-v44-c1-runtime-descriptor-contract-result-2026-09-03.md), [G0A](development/physical-sound-v44-g0a-structured-source-increment-result-2026-09-03.md) and [G0B0](development/physical-sound-v44-g0b0-ieteasy-prospective-parent-result-2026-09-03.md) freeze descriptors and the `15/150` IETeasy catalogue. [G0B1a](development/physical-sound-v44-g0b1a-ieteasy-payload-target-probe-result-2026-09-03.md) verifies all `15/15` selected payload/media/onset/target paths. [G0B1b](development/physical-sound-v44-g0b1b-target-cap-normalization-audit-result-2026-09-03.md) proves normalization exact but rejects every cap through 96. [G0B1c0](development/physical-sound-v44-g0b1c0-noise-robust-target-synthetic-result-2026-09-03.md) now repeat-exactly admits a fixed 75-value tonal/residual/count target on clean-mode, noise-only, mixture, frequency-shift, scale and resource controls with zero IETeasy target access. G0B1c1 may apply only that frozen target to the 15 selected records; current support remains unchanged and a second independent Steel project is still required before PSEL. Metadata-first V0S remains parallel; only B1, frozen V0, one-shot protected admission and deterministic cooking can authorize an opt-in prop, and every failure retains the authored fallback. |
