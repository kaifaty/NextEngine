...
| Physical sound source synthesis | SPEC-45 `Proposed`; Roadmap V13 status `M2B_REPEAT_EXACT_SOURCE_INCOMPLETE / M2C_REALIMPACT_CONTROL_NEXT / CANONICAL_SOURCE_RECOVERY_REQUIRED / MEASURED_TRANSFER_BLOCKED / CLIP_FALLBACK / P1_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [M2b](development/physical-sound-v13-m2b-object92-raw-force-inventory-result-2026-08-31.md) proves object `92 / Glass_Red` has all 36 raw microphone/force pairs but lacks `92/audio/35/metadata.yaml`; the next-object boundary makes this terminal without any sample decode. Next is the independent RealImpact control and a fresh canonical-source revision under [Roadmap V13](plans/physical-sound-synthesis-roadmap-v13.md); no role reduction, arbitrary-force transfer or production promotion is authorized. |
