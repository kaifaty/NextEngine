...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V29](plans/physical-sound-synthesis-roadmap-v29.md) status `ADOPTED / V28_M0C_CLOSED / Q0M_SOURCE_IDENTITIES_FEASIBLE / Q1M_SOURCE_POWER_OOD / Q1AM_SOURCE_GROWTH_NEXT / VALIDATOR_FIRST / CAUSAL_HYBRID_GENERATOR_RESEARCH / INTERNET_ONLY / AUTOMATIC_ADMISSION / CLIP_FALLBACK`; no public schema, content role, runtime model or production gate promoted | [Q1-M](development/physical-sound-v29-q1m-metal-role-power-result-2026-09-02.md) accounts for all 109 Q0 identities twice exactly with zero signal access and assigns no role: two projects miss the nine-project role floor, exact Steel is `23/32` for the two protected evaluations, `70/70` rejects leave none for development/calibration and current freshness power is zero. Q1a-M must add at least seven independent internet projects, nine exact-Steel groups before unprotected needs, extra reject capacity and a current exposure ledger. P0 may proceed independently; Metal training remains blocked and authored fallback stays authoritative. |
