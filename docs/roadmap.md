...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V37](plans/physical-sound-synthesis-roadmap-v37.md) is `ACTIVE / R0_N0_NR_RESEARCH_COMPLETE / QSO_V0_SELECTED / A0_F0_C0_REPEAT_EXACT_PASS / X0_NEXT / V36_CLOSED / H0_UNOPENED / ML_FIRST / AUTOMATIC_VALIDATION / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | [V36 D0](development/physical-sound-v36-d0-fresh-development-result-2026-09-03.md) closes scalar-hybrid contact transfer. Corrected [QSO A0](development/physical-sound-v37-a0-query-surface-contract-result-2026-09-03.md) and [F0](development/physical-sound-v37-f0-fresh-query-surface-operator-result-2026-09-03.md) freeze the typed boundary and fresh science. [C0](development/physical-sound-v37-c0-query-surface-structural-cost-result-2026-09-03.md) repeat-exactly proves 15,120 queries, remesh/topology/ablation reachability and all nine cost paths below the frozen `300 s / 1 GiB` envelope with zero scientific target/truth/official access. X0 complete-owner terminal conformance is next; the independent source lane remains six exact-Steel and 27 non-Metal groups short. |
