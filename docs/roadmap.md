...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive handling, AV-MSF + YCB + Heller E3 normalization/coverage, one typed REALIMPACT adapter with two frozen E2 object rows and the Greatest Hits object-identity rejection `IMPLEMENTED`; current status `PS-2_THREE_E3_PROJECT_GROUPS / GLASS_5_OF_16 / TWO_REALIMPACT_E2_OBJECTS / E3_EXPANSION_NEXT / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md), [source/cache evidence](development/physical-sound-internet-source-pipeline-ps2-2026-08-27.md), [AV-MSF multi-object E3 pilot](development/physical-sound-av-msf-e3-multiobject-pilot-ps2-2026-08-27.md), [independent YCB E3 pilot](development/physical-sound-ycb-independent-e3-pilot-ps2-2026-08-27.md), [independent Heller E3 pilot](development/physical-sound-heller-independent-e3-pilot-ps2-2026-08-27.md), [Greatest Hits discriminator](development/physical-sound-greatest-hits-discriminator-ps2-2026-08-27.md), [REALIMPACT E2 adapter](development/physical-sound-realimpact-e2-adapter-ps2-2026-08-27.md) and [GreenGoblet bounded-range E2 pilot](development/physical-sound-realimpact-green-goblet-range-pilot-ps2-2026-08-27.md): local capture is retired. Two exact REALIMPACT object rows have typed transfer/geometry/position evidence but remain fallback; GreenGoblet repeats from 1.61 MB of ranges rather than the 2.31 GB full archive. Three E3 projects validate 13 objects/33 recordings and Glass remains 5/16 because E2 does not create validator groups. Greatest Hits exposes material events but no stable object IDs and receives no E3 credit. Next resume stable-object E3 expansion; 11 in-domain groups and at least 35 reject parents remain open before PS-3/AV-P0D. Insufficient published evidence remains fallback-only; R&D stays PresentationOnly and production P1 gates are unchanged. |
