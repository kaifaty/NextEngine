...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive handling, AV-MSF + YCB + Heller E3 normalization/coverage, one frozen REALIMPACT typed E2 adapter and the Greatest Hits object-identity rejection `IMPLEMENTED`; current status `PS-2_THREE_E3_PROJECT_GROUPS / GLASS_5_OF_16 / GREATEST_HITS_E3_REJECTED / REALIMPACT_GREEN_GOBLET_RANGE_NEXT / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md), [source/cache evidence](development/physical-sound-internet-source-pipeline-ps2-2026-08-27.md), [AV-MSF multi-object E3 pilot](development/physical-sound-av-msf-e3-multiobject-pilot-ps2-2026-08-27.md), [independent YCB E3 pilot](development/physical-sound-ycb-independent-e3-pilot-ps2-2026-08-27.md), [independent Heller E3 pilot](development/physical-sound-heller-independent-e3-pilot-ps2-2026-08-27.md), [Greatest Hits discriminator](development/physical-sound-greatest-hits-discriminator-ps2-2026-08-27.md) and [REALIMPACT E2 adapter](development/physical-sound-realimpact-e2-adapter-ps2-2026-08-27.md): local capture is retired. One exact REALIMPACT row has typed transfer/geometry/position evidence but remains fallback; three E3 projects validate 13 objects/33 recordings and Glass reaches 5/16. Greatest Hits exposes material events but no stable object IDs and receives no E3 credit. Next range-inspect `93_GreenGoblet.zip` and attempt one exact selected E2 row without the 2.31 GB full download; 11 in-domain groups and at least 35 reject parents remain open before PS-3/AV-P0D. Insufficient published evidence remains fallback-only; R&D stays PresentationOnly and production P1 gates are unchanged. |
