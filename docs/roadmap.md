...
cleanup, R3, functional R4a–R4d и bounded R5a–R5g завершены; следующий WIP slot
выбирает R5 completion audit.
...
completion audit выбирает следующий bounded WIP slot после завершённого R5g.
