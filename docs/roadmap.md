...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V32](plans/physical-sound-synthesis-roadmap-v32.md) status `ADOPTED / P0_P1_T0_V0A_COMPLETE / V0_V1_REJECT_PRESERVED / M0_PROTOCOL_FROZEN / M0_IMPLEMENTATION_NEXT / VALIDATOR_FIRST / BOUNDED_SOURCE_SCOUTING / REAL_RELEASE_BLOCKED_BY_SOURCE_POWER / OFFLINE_ML_ONLY / NO_PER_SOUND_HUMAN_REVIEW / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | The [M0 protocol](development/physical-sound-v32-m0-physics-locked-residual-protocol-2026-09-02.md) freezes one `1,491`-parameter branch-isolated residual family before implementation: P1 retains exact frequency, nodes, impulse scaling and remesh identity while ML may only bound decay/global-gain/contact multipliers. [V0a](development/physical-sound-v32-v0a-modal-equivalence-validator-result-2026-09-02.md) stays exact, and [E2](development/physical-sound-v30-e2-q1a-source-growth-result-2026-09-02.md) still leaves the weaker role six exact-Steel and 27 non-Metal groups short; real calibration, training, admission and cooking remain sealed. |
