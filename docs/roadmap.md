...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive/Ogg/RAR5 handling, eight E3 project sources, explicit target/reject-parent roles, five frozen REALIMPACT E2 rows, split-feasibility, deterministic split verification, exact-domain E2/E3 matrix and bounded published-source feasibility gate `IMPLEMENTED`; current status `PS-2_SOURCE_FEASIBILITY_EXECUTABLE / V1_PUBLISHED_ROUTE_UNAVAILABLE / REALIMPACT_TRANSFER_ROUTE_SELECTED / EIGHT_EXACT_CLAIMS_OPEN / FALLBACK_OUT_OF_DOMAIN / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md) and [source-feasibility evidence](development/physical-sound-internet-source-feasibility-ps2-2026-08-28.md). Local capture is retired. Eight E3 projects validate 64 objects/135 recordings; Glass is 16/16 and 46 recordings, reject parents 48/35 and 89. The verified `2/2/2/2` project split and one Blue Bowl bridge remain frozen. A repeated gate reviewed REALIMPACT, ObjectFolder Real and AV-MSF primary surfaces and closed none of the eight exact V1 blockers. V1 therefore stays fallback-only. The next preregistered route is REALIMPACT normalized-transfer calibration for relative modal/spatial fitting only; absolute amplitude, exact material/support, corpus admission, `Pass`, PS-3, AV-P0D and production P1 remain disabled. |
