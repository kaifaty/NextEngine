...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive/Ogg/RAR5 handling, eight E3 project sources, explicit target/reject-parent roles, five typed REALIMPACT E2 rows, exact-domain/source gates, V1/V2 transfer calibration, listener acquisition, spatial-representation rejection chain, analytical boundary harness, independent Bempp control and directional quadrupole near-to-far cooker `IMPLEMENTED`; current status `PS-2_QUADRUPOLE_SURFACE_MODE_COOKER_SUPPORTED / ALL_FROZEN_FIELD_AND_COOKER_GATES_PASS / BYTE_IDENTICAL_REPEATS / NO_FRESH_DATA_OPENED / TWO_HOLDOUT_OBJECTS_PRESERVED / NONSPHERICAL_CLOSED_MESH_NEXT / THREE_DIMENSIONAL_SPATIAL_FIELD_OPEN / EIGHT_EXACT_CLAIMS_OPEN / FALLBACK_OUT_OF_DOMAIN / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md) and [quadrupole surface-mode evidence](development/physical-sound-bempp-quadrupole-surface-mode-ps2-2026-08-28.md). Local capture is retired. Bempp V3 reaches `4.5546%` maximum peak-normalized error, `1.293e-6` nodal leakage, `0.9999978` correlation and `0.2713x` refinement on the analytical quadrupole; report `e8e1d4d5…6437` repeats. The Rust cooker predicts 132 held far-field conditions with `0.7856%` maximum error and repeats at `054901ee…f871`. Credit is one axisymmetric spherical surface mode only. Open no fresh data. Next freeze one genuinely non-spherical closed mesh. All eight exact-domain blockers, real 3D spatial credit, corpus admission, `Pass`, PS-3, AV-P0D and production P1 remain disabled. |
