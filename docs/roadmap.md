...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive/Ogg/RAR5 handling, eight E3 project sources, explicit target/reject-parent roles, five typed REALIMPACT E2 rows, exact-domain/source gates, V1/V2 transfer calibration, listener acquisition, spatial-representation rejection chain, analytical boundary harness, independent Bempp controls, prescribed spherical/triaxial modes, elastic FEM coupling and a full-angular near-to-far cooker `IMPLEMENTED`; current status `PS-2_ELASTIC_FEM_BEMPP_COOKER_SUPPORTED / COARSE_FEM_PROTOCOL_REJECTED / BYTE_IDENTICAL_REPEATS / NO_FRESH_DATA_OPENED / TWO_HOLDOUT_OBJECTS_PRESERVED / FRESH_OBJECT_DISJOINT_SPATIAL_TRANSFER_PREREGISTRATION_NEXT / REAL_3D_FIELD_OPEN / EIGHT_EXACT_CLAIMS_OPEN / FALLBACK_OUT_OF_DOMAIN / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md) and [elastic FEM/Bempp evidence](development/physical-sound-fem-eigenmode-bempp-cooker-ps2-2026-08-28.md). Local capture is retired. The coarse FEM schedule remains rejected at `a58f28b9…90ef`. Refined `128/512/2048` meshes pass all 16 FEM/Bempp gates and repeat at `a71515fa…a667`; the full-near-shell cooker rejects `m=0`, selects full degree 2 and predicts 112 held `4L/10L` conditions with `3.0975%` maximum error and `0.9996932` minimum correlation, repeating at `c3101130…b476`. Credit is synthetic elastic-mode representation only. Open no fresh data. Next preregister a fresh object-disjoint real spatial-transfer calibration before opening reserved payloads. All eight exact-domain blockers, real 3D spatial credit, corpus admission, `Pass`, PS-3, AV-P0D and production P1 remain disabled. |
