...
| Local continuum materials: water, deformable terrain, mud and off-road coupling | `SOURCE_LINE_STOPPED / FCR2_REFERENCE_PASS / FCR3A_BLOCK_V1_FAIL / HYBRID_V2_NEXT / INTEGRATION_BLOCKED`; SPEC-38/ADR-076 `Proposed`; water W1 `LINUX_W1_PASS / CONTINUUM-WATER-REF-P1=PASS` at `fe223f9`; CPU/direct-GPU W2 miss; separate `nuv-variational-fcr1` has a slow strict-f64 objective reference but no selected fast solver/product profile; later ProductChecks remain `NOT_RUN` | W0F/G/H/I roots remain frozen and W3 remains blocked. NPR1-B stopped the source-shaped [productionization line](plans/nonlocal-continuum-production/README.md); its performance evidence grants no corrected-line credit. The separate [formula-reclosure roadmap](plans/nonlocal-continuum-formula-reclosure/README.md) has FCR0–FCR2 reference evidence. Pure block conditioning reduces backtracks `3788→7` but fails fixed-budget final gradient quality in exact [FCR3-A evidence](development/nonlocal-continuum-fcr3a-block-evidence-2026-08-20.md); one coarse-block/inertial-polish remediation is active. Profile, CUDA, performance, integration and public contracts remain blocked. DFSPH remains the water correctness reference; independent terrain closure remains Package 10T. |
