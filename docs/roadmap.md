...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V32](plans/physical-sound-synthesis-roadmap-v32.md) status `ADOPTED / P0_P1_T0_COMPLETE / V0_PROTOCOL_FROZEN / V0_IMPLEMENTATION_NEXT / VALIDATOR_FIRST / BOUNDED_SOURCE_SCOUTING / REAL_RELEASE_BLOCKED_BY_SOURCE_POWER / OFFLINE_ML_ONLY / NO_PER_SOUND_HUMAN_REVIEW / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | [T0](development/physical-sound-v32-t0-truth-mutation-result-2026-09-02.md) publishes two byte-identical 35-file synthetic truth trees: all nine clean P1 renders remain exact and all seven frozen corruptions pass their invariant/reason matrix with zero real signal/model/network access. The [V0 protocol](development/physical-sound-v32-v0-validator-mechanics-protocol-2026-09-02.md) now freezes label-blind candidate views, independent specialists, cache identity, reason precedence and OOD before validator feature values. [E2](development/physical-sound-v30-e2-q1a-source-growth-result-2026-09-02.md) still leaves the weaker role six exact-Steel and 27 non-Metal groups short; real calibration, training, admission and cooking remain sealed. |
