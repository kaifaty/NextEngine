...
| Local continuum materials: water, deformable terrain, mud and off-road coupling | `SOURCE_LINE_STOPPED / FCR2_REFERENCE_PASS / FORMULA_RECLOSURE_STOP / NEWTON_KRYLOV_NSR2C2_PASS / NSR3_B2_PASS / NSR3_B3_FAIL / NSR3_B3D_ACTIVE_REACTION_PASS_INACTIVE_CERT_REJECT / NSR3_B3D1_DISPLACEMENT_PASS_ENERGY_FLOOR_FAIL / NSR3_B3D2_STATIONARITY_MERIT_SELECTED / NSR3_B3D3_ONE_TRIAL_FAIL / NSR3_B3D4_OWNED_GRADIENT_PASS / NSR3_B3D5_OWNED_RESIDUAL_PASS / NSR3_B3R_STATIC_BOUNDARY_PASS / NSR3_B4A_CLOSED_BOX_PASS / NSR3_B4B2_TINY_PRESSURE_PASS / NSR3_B4C0_EXACT_WORK_FAIL / NSR3_B4C0R_JOINT_NEIGHBOR_PASS / NSR3_B4C3MAR_ADAPTIVE_MACRO_PASS / NSR3_B4C3MC0_MEASUREMENT_PASS / NSR3_B4C3MC1_TINY_ACCURACY_PASS / NSR3_RESEARCH_ACTIVE / INTEGRATION_BLOCKED`; SPEC-38/ADR-076 `Proposed`; later ProductChecks remain `NOT_RUN` | W0F/G/H/I roots remain frozen and W3 remains blocked. NPR1-B and FCR3-B2 remain exact negative evidence. The separate [nonlinear-solver roadmap](plans/nonlocal-nonlinear-solver-research/README.md) proves the analytic HVP, exact canonical neighborhoods, guarded trust-region solve and box KKT path. B4C0 rejects two-pass work; B4C0R preserves its roots with one pre-admitted scan. Later B4C3 stages establish aggregate-balanced canonical publication, KKT-scale ledger, mixed fixed-reference stability, exact canonical topology and complete macro-only adaptive replay. B4C3MC0 measures that replay against fixed `48/96/192`; B4C3MC1 selects the unchanged physical accuracy budget only for P1/P2 while explicitly withholding temporal-equivalence and production claims. Nominal diverse corpus design is next. Viscosity walls, surface calibration, internal aperture, CUDA, performance, integration and public contracts remain blocked. DFSPH remains the water correctness reference; terrain remains Package 10T. |
