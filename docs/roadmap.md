...
| Local continuum materials: water, deformable terrain, mud and off-road coupling | `SOURCE_LINE_STOPPED / FCR2_REFERENCE_PASS / FCR3A_CONDITIONING_NEXT / INTEGRATION_BLOCKED`; SPEC-38/ADR-076 `Proposed`; water W1 `LINUX_W1_PASS / CONTINUUM-WATER-REF-P1=PASS` at `fe223f9`; CPU/direct-GPU W2 miss; source-shaped Nonlocal standalone performance passes but NPR1-B physical formula consistency fails; separate `nuv-variational-fcr1` has a slow strict-f64 objective reference but no selected SISSM/product profile; later ProductChecks remain `NOT_RUN` | W0F/G/H/I roots remain frozen and W3 remains blocked. [The performance decision](development/nonlocal-continuum-performance-decision-2026-08-20.md) remains valid only for the exact source-shaped laboratory arithmetic and grants no W2 credit. NPR1-B stopped that exact [productionization line](plans/nonlocal-continuum-production/README.md). The separate [formula-reclosure roadmap](plans/nonlocal-continuum-formula-reclosure/README.md) now has exact FCR0 algebra, FCR1 pair/pressure and [FCR2 variational-reference evidence](development/nonlocal-continuum-fcr2-reference-evidence-2026-08-20.md). FCR2 exposes accepted alphas down to `4.66e-10`, so corrected SISSM/reference conditioning precedes profile, CUDA and performance work. No old v4 roots/authority, GPU authority, integration or public contract changes follow. DFSPH remains the water correctness reference; independent terrain closure remains Package 10T. |
