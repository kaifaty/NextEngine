...
| PhysX deterministic humanoid substrate | ADR-058/059/062/063/064/065/067/069/071/100/101/102 `Accepted`; immutable Stage 0 V1 and biomechanics V2/standing V1 environments remain negative evidence; biomechanics V3/standing V2 completes its hash-closed 1,024,000-sample run plus one GPU and five canonical CPU full-horizon nominal evaluations; Stage 0 product evidence remains incomplete | Close paired V3 `MODEL-MIRROR-P1`, then create the distinct bounded forward start/stop environment and run. Runtime promotion remains blocked on the full correspondence/quality matrix. |
