...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive/Ogg/RAR5 handling, eight E3 project sources, explicit target/reject-parent roles, five typed REALIMPACT E2 rows, exact-domain/source gates, V1/V2 transfer calibration, listener acquisition, narrow vertical holdout and fixed/bbox/frequency/complex-multipole rejection chain `IMPLEMENTED`; current status `PS-2_COMPLEX_MULTIPOLE_REPRESENTATION_REJECTED / NO_FRESH_DATA_OPENED / TWO_HOLDOUT_OBJECTS_PRESERVED / CLASSICAL_SURFACE_MODE_BEM_FEASIBILITY_NEXT / THREE_DIMENSIONAL_SPATIAL_FIELD_OPEN / EIGHT_EXACT_CLAIMS_OPEN / FALLBACK_OUT_OF_DOMAIN / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md) and [modal-radiation evidence](development/physical-sound-realimpact-modal-radiation-representation-ps2-2026-08-28.md). Local capture is retired. V2 passes narrow modal/damping and the original vertical RBF remains a narrow positive pilot, but wider kernels fail. An order-three complex multipole basis then passes `14/14` absolute gates on already-open blocks while losing median `1.2506x`, maximum `2.0861x`, p90 `+7.2513 dB` and improved fraction `0.3482`; reports repeat at `7cbf7c59…f25`. Open no fresh data. Next hash-close classical surface-mode/BEM output on one analytical synthetic fixture before neural acceleration or REALIMPACT validation. All eight exact-domain blockers, 3D spatial credit, corpus admission, `Pass`, PS-3, AV-P0D and production P1 remain disabled. |
