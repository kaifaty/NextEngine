...
CONTINUUM-WATER-VOLUME-P1=PASS / PRESENTATION_NEXT`. Under Proposed ADR-100
...
CPU lane is `67x` over budget; under Proposed ADR-100 the integration track
