...
| Local continuum materials: water, deformable terrain, mud and off-road coupling | `SOURCE_LINE_STOPPED / FCR2_REFERENCE_PASS / FCR3A_CLOSED_FAIL / FCR3B_V1_FAIL / TERM_LOCAL_NEXT / INTEGRATION_BLOCKED`; SPEC-38/ADR-076 `Proposed`; separate `nuv-variational-fcr1` has a slow strict-f64 objective reference but no selected fast solver/product profile; later ProductChecks remain `NOT_RUN` | W0F/G/H/I roots remain frozen and W3 remains blocked. NPR1-B stopped the source-shaped line; its performance evidence grants no corrected-line credit. The separate [formula-reclosure roadmap](plans/nonlocal-continuum-formula-reclosure/README.md) has FCR0–FCR2 reference evidence. Local conditioning is closed negative; corrected SISSM v1 passes isolated terms but fails combined quality/cost in [FCR3-B evidence](development/nonlocal-continuum-fcr3b-sissm-v1-evidence-2026-08-20.md). One term-localized combination discriminator is active. Profile, CUDA, performance, integration and public contracts remain blocked. DFSPH remains the water correctness reference; terrain remains Package 10T. |
