...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V20](plans/physical-sound-synthesis-roadmap-v20.md) status `ADOPTED / R0_COMPLETE / M0_PROTOCOL_FROZEN / M0_IMPLEMENTATION_PENDING / P0C_BLOCKED_BY_M0 / I1_SEALED / SOURCE_GROWTH_PARALLEL / ADMISSION_BLOCKED / CLIP_FALLBACK / P1_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [V19 I0 development control](development/physical-sound-v19-i0-development-control-result-2026-09-01.md) closes integration before fresh values: passing B0/F0 errors still produce raw waveform/envelope rejection because allowed pitch error accumulates phase, while multiresolution spectrum passes. [V20 M0](development/physical-sound-v20-m0-phase-consistent-metric-protocol-2026-09-01.md) freezes exact hard/modal, MR-STFT, decay/transient-energy controls on opened development only before fresh `1701…1712` integration. [S0c](development/physical-sound-v15-s0c-source-sufficiency-role-freeze-result-2026-09-01.md) independently keeps real admission blocked under unchanged `4/1/1/1/1`; authored clips remain complete fallback. |
