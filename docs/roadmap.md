...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V32](plans/physical-sound-synthesis-roadmap-v32.md) status `ADOPTED / P0_P1_T0_V0A_M0_CONFORMANCE_COMPLETE / V0_V1_REJECT_PRESERVED / M1_OWNER_NEXT / VALIDATOR_FIRST / BOUNDED_SOURCE_SCOUTING / REAL_RELEASE_BLOCKED_BY_SOURCE_POWER / OFFLINE_ML_ONLY / NO_PER_SOUND_HUMAN_REVIEW / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | [M0 conformance](development/physical-sound-v32-m0-physics-locked-residual-conformance-result-2026-09-02.md) passes two byte-identical three-file publications at exactly `1,491` parameters while P1 frequency/nodes/impulse/remesh remain structural and no official development/holdout value opens. M1 owner/tournament is next. [V0a](development/physical-sound-v32-v0a-modal-equivalence-validator-result-2026-09-02.md) stays exact, and [E2](development/physical-sound-v30-e2-q1a-source-growth-result-2026-09-02.md) still leaves the weaker role six exact-Steel and 27 non-Metal groups short; real calibration, training, admission and cooking remain sealed. |
