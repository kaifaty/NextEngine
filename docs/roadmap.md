...
| Physical sound source synthesis | SPEC-45 `Proposed`; Roadmap V12 targets `ACQUISITION_COVERAGE_CERTIFICATE / EXPLICIT_MODAL_TRANSFER / CONSTRAINED_OFFLINE_ML / INDEPENDENT_VALIDATOR / BAKED_CLIP_ATLAS`; current status `A1R_FORCE_ONSET_PASS / V9_REAL_FIT_REJECTED / B1R3_REPEAT_REJECTED / C1_REPEAT_PASS / C2_SOURCE_PASS / C3_REPEAT_PASS / C4A_PROTOCOL_FROZEN / C4A_RUNNER_NEXT / FIT_PCM_CLOSED / VALIDATOR_NOT_RELEASED / CLIP_FALLBACK / P1_BLOCKED`; no public schema, content role, runtime model or production gate promoted | Follow [Roadmap V12](plans/physical-sound-synthesis-roadmap-v12.md), the [C4a protocol](development/physical-sound-r3a-v12-c4-object41-real-frf-fit-protocol-2026-08-31.md), [C1 result](development/physical-sound-r3a-v12-c1-acquisition-coverage-oracle-result-2026-08-31.md) and [C3 result](development/physical-sound-r3a-v12-c3-object41-source-role-freeze-result-2026-08-31.md). C1 recovers `7/7` known poles with calibrated OOD; C2+C3 bind fresh `41 / Wrench_Large / Steel` to all `35` paired force/mic trials and six signal-blind roles. C4a now freezes a one-shot real FRF fit around force-only coverage, leave-quarter-out common-pole stability and a causal force-permutation control. The runner is next; fit PCM and every protected role remain closed. ML, validator release and runtime stay closed; production requires a concrete consumer and ADR-046 gate. |
