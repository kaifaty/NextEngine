...
| Local continuum materials: water, deformable terrain, mud and off-road coupling | `SOURCE_LINE_STOPPED / FCR2_REFERENCE_PASS / FCR3A_CONDITIONING_CLOSED_FAIL / FCR3B_SISSM_NEXT / INTEGRATION_BLOCKED`; SPEC-38/ADR-076 `Proposed`; water W1 `LINUX_W1_PASS / CONTINUUM-WATER-REF-P1=PASS` at `fe223f9`; CPU/direct-GPU W2 miss; separate `nuv-variational-fcr1` has a slow strict-f64 objective reference but no selected fast solver/product profile; later ProductChecks remain `NOT_RUN` | W0F/G/H/I roots remain frozen and W3 remains blocked. NPR1-B stopped the source-shaped [productionization line](plans/nonlocal-continuum-production/README.md); its performance evidence grants no corrected-line credit. The separate [formula-reclosure roadmap](plans/nonlocal-continuum-formula-reclosure/README.md) has FCR0–FCR2 reference evidence. Pure block and the sole [hybrid remediation](development/nonlocal-continuum-fcr3a-hybrid-evidence-2026-08-20.md) reduce backtracking but fail fixed-budget final gradient quality, closing FCR3-A; corrected SISSM/reference correspondence is next. Profile, CUDA, performance, integration and public contracts remain blocked. DFSPH remains the water correctness reference; independent terrain closure remains Package 10T. |
