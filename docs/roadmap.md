...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V34](plans/physical-sound-synthesis-roadmap-v34.md) status `ADOPTED / R0_COMPLETE / F0_NEXT / TARGET_SAFE_PREFLIGHT_FIRST / V33_PROTOCOL_REJECT / VALIDATOR_FIRST / REAL_RELEASE_BLOCKED / OFFLINE_ML_ONLY / AUTHORED_FALLBACK`; no public schema, content role, runtime model or production gate promoted | [V34 R0](development/physical-sound-v34-protocol-closure-rebaseline-2026-09-02.md) preserves the still-untested spectral hypothesis but requires fresh roles. Before training, F0/C0 must freeze and prove a zero-target per-role hard-gate witness census; T0 must prove every whole-owner post-access scientific terminal publishes atomically. Only then may D0/H0 evaluate quality once. [V33 D0](development/physical-sound-v33-d0-fresh-development-tournament-result-2026-09-02.md) remains immutable no-quality protocol evidence with spent train/development and unopened holdout. [E2](development/physical-sound-v30-e2-q1a-source-growth-result-2026-09-02.md) still leaves the weaker real role six exact-Steel and 27 non-Metal groups short, so real calibration, training, admission and cooking remain sealed. |
