...
| Physical sound source synthesis | SPEC-45 `Proposed`; Roadmap V17 status `R0_RESEARCH_COMPLETE / P0A_PROTOCOL_NEXT / V16_PRIMARY_CLOSED / SOURCE_GROWTH_PARALLEL / ADMISSION_BLOCKED / METAL_FIRST / CLIP_FALLBACK / P1_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [V17](plans/physical-sound-synthesis-roadmap-v17.md) responds to the repeat-exact [V16 L0b rejection](development/physical-sound-v16-l0b-known-truth-neural-oracle-result-2026-09-01.md) by separating scale-normalized global modes, model-independent intrinsic coverage and a masked intrinsic surface operator before any integrated waveform test. P0a must freeze new disjoint truth corpora, successful controls, sample rationale and stop rules before implementation. [S0c](development/physical-sound-v15-s0c-source-sufficiency-role-freeze-result-2026-09-01.md) independently keeps real admission blocked under the unchanged `4/1/1/1/1` shape. Runtime inference and production promotion remain separately blocked. |
