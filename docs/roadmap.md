...
| Physical sound source synthesis | SPEC-45 `Proposed`; P0/P0.5, AV-P0A/B/C, PS-1, PS-2 plan/pilot/`E1` import, bounded internet source/cache/archive/Ogg/RAR5 handling, eight E3 project sources, explicit target/reject-parent roles, five frozen REALIMPACT E2 rows, deterministic split, exact-domain/source gates, V1/V2 transfer calibration, exact 15-listener acquisition and preregistered object-disjoint vertical spectral holdout `IMPLEMENTED`; current status `PS-2_VERTICAL_SPECTRAL_HOLDOUT_PASS / TRANSFER_V2_MODAL_DAMPING_HOLDOUT_PASS / THREE_DIMENSIONAL_SPATIAL_FIELD_OPEN / TWO_ADDITIONAL_OBJECT_HOLDOUTS_NEXT / EIGHT_EXACT_CLAIMS_OPEN / FALLBACK_OUT_OF_DOMAIN / SELECTIVE_PASS_DISABLED / P1_BLOCKED`; no public schema, content role or production gate promoted | Follow the [physical-sound subsystem roadmap](plans/physical-sound-synthesis-roadmap.md), [internet corpus policy](development/physical-sound-internet-corpus-policy-ps2-2026-08-27.md) and [vertical spatial evidence](development/physical-sound-realimpact-spatial-calibration-ps2-2026-08-28.md). Local capture is retired. Eight E3 projects validate 64 objects/135 recordings; Glass is 16/16 and 46 recordings, reject parents 48/35 and 89. Transfer V1 remains invalid; injective V2 passes its narrow modal/damping holdout. The Green/Shell/Skull run freezes four candidates before new row access, selects RBF on Shell and crosses all six Skull gates; improved-component fraction is exactly the `0.5` threshold. Next keep the candidate frozen, add at least two object-disjoint impact blocks and introduce explicit angle/distance partitions before any 3D spatial representation. All eight exact-domain blockers, corpus admission, `Pass`, PS-3, AV-P0D and production P1 remain disabled. |
