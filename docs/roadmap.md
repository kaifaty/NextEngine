...
| Local continuum materials: water, deformable terrain, mud and off-road coupling | `SOURCE_LINE_STOPPED / FCR2_REFERENCE_PASS / FORMULA_RECLOSURE_STOP / NEWTON_KRYLOV_NSR2C2_PASS / NSR3_RESEARCH_ACTIVE / INTEGRATION_BLOCKED`; SPEC-38/ADR-076 `Proposed`; later ProductChecks remain `NOT_RUN` | W0F/G/H/I roots remain frozen and W3 remains blocked. NPR1-B and FCR3-B2 remain exact negative evidence. The separate [nonlinear-solver roadmap](plans/nonlocal-nonlinear-solver-research/README.md) proves the full analytic HVP, exact canonical neighborhoods and a bounded guarded trust-region path through 1000 particles; the former 512-particle arithmetic-floor failure is reduced from `26/13/153` outer/reject/HVP to `12/0/46`. This remains single-step report-only evidence: measured baseline, physical corpus, multi-step stability, CUDA, performance, integration and public contracts remain open. DFSPH remains the water correctness reference; terrain remains Package 10T. |
