...
| Physical sound source synthesis | SPEC-45 `Proposed`; [Roadmap V23](plans/physical-sound-synthesis-roadmap-v23.md) status `ADOPTED / V21_RESOURCE_REJECT / V22_IMPLEMENTATION_REJECT / QUALITY_UNOBSERVED / FIXED_FEATURE_RIDGE_SELECTED / P2A_FROZEN / E2A_IMPLEMENTATION_NEXT / FRESH_VALUES_SEALED / SOURCE_GROWTH_PARALLEL / ADMISSION_BLOCKED / CLIP_FALLBACK / P3_BLOCKED`; no public schema, content role, runtime model or production gate promoted | [V22 F1r](development/physical-sound-v22-f1r-resource-bounded-result-2026-09-01.md) passed numeric equivalence but omitted one inherited evaluator API and failed before publication; `2201…2312` are spent with no quality claim. [P2a](development/physical-sound-v23-p2a-fixed-feature-ridge-protocol-2026-09-01.md) freezes eight fixed-feature ridge candidates, fresh `2601…2912`, 5-minute resources and a twice-exact whole-evaluator API smoke; strict `0.50`, independent internet-source admission and complete authored fallback remain unchanged. |
