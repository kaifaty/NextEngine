...
pub(crate) fn run_content_package_check_with_scratch(
    ...
    if source.root_asset_ids.len() != 41 {
    ...
    let result = (|| {
        ...
        let humanoid_mesh = catalog
            ...
            .ok_or(ContentPackageCheckError::FixtureClosureMismatch)?;
        if activated.content_manifest.body.asset_entries.len() != 127
            ...
            || prepared.check.rendered_object_count != 12
            || prepared.check.indexed_draw_count != 12
