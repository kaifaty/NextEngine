...
pub(crate) const WORKER_FAILURE: &str = "WATER_WORKER_FAILURE";
pub(crate) const AUDIT_MISMATCH: &str = "WATER_AUDIT_MISMATCH";
pub(crate) const AUDIT_INVALID: &str = "WATER_AUDIT_INVALID";
