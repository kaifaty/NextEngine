...
fn repeated_cooking_is_byte_identical_and_activates_through_production_loader() {
    ...
    assert_eq!(activated.content_manifest.body.root_assets.len(), 41);
    assert_eq!(activated.content_manifest.body.asset_entries.len(), 127);
    ...
    assert_eq!(activated.render_content_catalog.meshes().len(), 15);
