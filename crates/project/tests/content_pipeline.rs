...
fn repeated_cooking_is_byte_identical_and_activates_through_production_loader() {
    ...
    assert_eq!(activated.content_manifest.body.root_assets.len(), 42);
    assert_eq!(activated.content_manifest.body.asset_entries.len(), 128);
    ...
    assert_eq!(activated.render_content_catalog.meshes().len(), 16);
