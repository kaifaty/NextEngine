...
pub use water::{
    ...
    REFERENCE_WATER_VESSEL_B_ID, REFERENCE_WATER_VESSEL_B_SURFACE_OBJECT_ID, player_submersion,
    reference_water_basin_definition, reference_water_flow, reference_water_flow_edges,
    reference_water_pond_definition, reference_water_vessel_definitions, reference_water_volumes,
...
pub use water_presentation::{
    ...
    WATER_SPLASH_SPEED_THRESHOLD_MICROMETRES_PER_SECOND, WATER_SURFACE_INDEX_CAPACITY,
    WATER_SURFACE_VERTEX_CAPACITY, WaterEdgePresentationKindV1, WaterEdgePresentationV1,
    WaterFloatingBoxV1, WaterJetParticlesV1, WaterPresentationFrameV1, WaterSurfaceBindingV1,
