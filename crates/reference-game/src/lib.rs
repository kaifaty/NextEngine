...
pub use water::{
    ...
    REFERENCE_WATER_DRAIN_ID, REFERENCE_WATER_FALL_ID, REFERENCE_WATER_FLOW_GATE_ID,
    REFERENCE_WATER_FLOW_SINK_ID, REFERENCE_WATER_FLOW_SOURCE_ID,
    REFERENCE_WATER_FLOW_TICKS_PER_SECOND, REFERENCE_WATER_GATE_LEVER_BODY_ID,
    REFERENCE_WATER_GATE_LEVER_BOX_MICROMETRES, REFERENCE_WATER_GATE_SYSTEM_ID,
    REFERENCE_WATER_LAKE_ID, REFERENCE_WATER_LAKE_INITIAL_LEVEL_MICROMETRES,
    ...
    REFERENCE_WATER_POND_MINIMUM_MICROMETRES, REFERENCE_WATER_POND_SURFACE_OBJECT_ID,
    REFERENCE_WATER_SPRING_ID, REFERENCE_WATER_SPRING_RATE_CUBIC_MILLIMETRES_PER_SECOND,
    REFERENCE_WATER_STREAM_REGION_ID, REFERENCE_WATER_VESSEL_A_ID,
    REFERENCE_WATER_VESSEL_A_SURFACE_OBJECT_ID, REFERENCE_WATER_VESSEL_B_ID,
    REFERENCE_WATER_VESSEL_B_SURFACE_OBJECT_ID, REFERENCE_WATER_WEIR_ID,
    REFERENCE_WATER_WORKS_BODY_ID, player_submersion, reference_water_basin_definition,
    reference_water_flow, reference_water_flow_edges, reference_water_lake_definition,
    reference_water_pond_definition, reference_water_showcase_definitions,
    reference_water_stream_cell_ids, reference_water_stream_region,
    reference_water_vessel_definitions, reference_water_volumes, reference_water_works_boxes,
    volume_surface_translation, water_surface_translation,
};
