...
use next_project::{NeutralProjectSourceV1, ProjectCookError};
...
pub fn project_source_v2() -> Result<NeutralProjectSourceV1, ProjectCookError> {
    Ok(next_project::load_project_authoring_v1(
...
pub fn project_source_v2_with_id(
    ...
    Ok(next_project::load_project_authoring_v1_with_project_id(
        reference_alpha_project_directory(),
        project_id,
    )?)
}
