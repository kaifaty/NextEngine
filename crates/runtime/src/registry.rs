...
impl CommandKindRegistry {
    ...
    pub fn core_v1() -> Self {
        ...
        let descriptor = CommandKindDescriptor {
        ...
        Self {
            ...
            descriptors: BTreeMap::from([((schema_id, 1), descriptor)]),
        }
    }
...
mod tests {
    use next_contracts::{
        COMMAND_SCHEMA_VERSION, CommandPayload, NOOP_COMMAND_SCHEMA_ID, SchemaId,
    };

    use super::{COMMAND_KIND_REGISTRY_VERSION, CommandKindRegistry, NOOP_PRIORITY_CLASS};
