...
use crate::physics::{PhysicalEventV1, WATER_VOLUME_EVENT_SCHEMA_ID, WaterVolumeChangedV1};
...
impl DomainEventEnvelopeV2 {
    ...
    pub fn world_population(
        ...
        command_id: CommandId,
        event_slot: u32,
        payload: WorldPopulationChangedV1,
    ) -> Result<Self, CanonicalError> {
        Self::build(
            tick,
            phase,
    ...
    pub fn world_activity(
        ...
        command_id: CommandId,
        event_slot: u32,
        payload: WorldActivityChangedV1,
    ) -> Result<Self, CanonicalError> {
        Self::build(
            tick,
            phase,
...
impl EventPayload {
    fn canonical_body_bytes(&self, schema_id: &SchemaId) -> Result<Vec<u8>, CanonicalError> {
        let payload = match self {
            ...
            Self::WorldActivity(payload) => payload
                .canonical_payload_bytes()
                .map_err(|_| CanonicalError::DuplicateSequenceValue)?,
