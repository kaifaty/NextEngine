...
pub use core_profile::{
    ...
    CORE_RELATIONSHIP_TRUST_DIMENSION_ID, CoreDialogueQuestClosureError, RPG_COMMAND_CAPABILITY_ID,
    RPG_COMMAND_SCHEMA_ID, SKILL_PROFICIENCY_MAX, SkillProficiency, SkillProficiencyError,
};
pub use transaction::{
