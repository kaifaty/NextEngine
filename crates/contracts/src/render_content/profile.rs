...
pub const B0_SHADER_INTERFACE_MANIFEST_CANONICAL_BYTES: &[u8] =
    b"nextengine.shader-interface.b0.v1;vertex-inputs:location0-f32x3-position,location1-f32x2-uv0;descriptors:set0-binding0-uniform-buffer-vertex-min64,set1-binding0-combined-image-sampler-fragment-count1;push-constants:offset0-size80-vertex-fragment-model-mat4-base-color-factor-f32x4;fragment-output:location0-f32x4-rgba";
