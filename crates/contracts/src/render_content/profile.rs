...
pub const B0_SHADER_INTERFACE_MANIFEST_CANONICAL_BYTES: &[u8] =
    b"nextengine.shader-interface.b0.v4;vertex-inputs:location0-f32x3-position,location1-f32x2-uv0,location2-r16g16b16a16-snorm-normal;descriptors:set0-binding0-uniform-buffer-vertex-fragment-min208,set0-binding1-uniform-buffer-vertex-fragment-min576,set1-binding0-combined-image-sampler-fragment-count1,set2-binding0-combined-depth-compare-sampler-array-fragment-count1;push-constants:offset0-size96-vertex-fragment-model-mat4-base-color-factor-f32x4-material-params-f32x4;fragment-output:location0-f32x4-rgba";
