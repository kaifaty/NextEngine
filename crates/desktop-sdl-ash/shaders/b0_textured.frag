...
// B0 world material (scene look L1, plan look/01): the sky's SH irradiance,
// the sun in irradiance units with a GGX lobe, the 2048^2 shadow map with
// 3x3 PCF, fog in the sky's horizon radiance.
