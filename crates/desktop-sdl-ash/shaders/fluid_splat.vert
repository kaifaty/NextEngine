...
layout(set = 0, binding = 0, std140) uniform FluidFrame {
    ...
    vec4 spray;      // neighbour threshold, spray radius_m, spray alpha, 0
} frame;
...
void main() {
    ...
    // NGQ10 revision 2: particles below the neighbour threshold belong to
    // the spray pass; collapse their quad outside the clip volume.
