...
use ash::vk;
use next_contracts::{PresentationPrimitiveV1, PresentationSnapshotV2, ScenePresentationRecordV2};
...
impl GraphicsContext {
    fn new(window: &Window) -> Result<Self, DesktopAdapterError> {
    ...
    fn recreate_swapchain(&mut self, window: &Window) -> Result<(), DesktopAdapterError> {
        self.wait_idle()?;
    ...
    fn wait_idle(&self) -> Result<(), DesktopAdapterError> {
...
impl From<next_contracts::PresentationContractError> for DesktopAdapterError {
