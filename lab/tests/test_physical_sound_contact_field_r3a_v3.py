...
import physical_sound_contact_field_r3a_v3_codec_oracle as oracle  # noqa: E402
import physical_sound_contact_field_r3a_v3_common as common  # noqa: E402
import physical_sound_contact_field_r3a_v3_extract as extraction  # noqa: E402
import physical_sound_contact_field_r3a_v3_preflight as preflight  # noqa: E402


class PhysicalSoundContactFieldR3AV3Tests(unittest.TestCase):
    ...
    def test_metadata_split_rejects_duplicate_canonical_listener(self) -> None:
        ...
        with self.assertRaises(common.R3AV3Error):
