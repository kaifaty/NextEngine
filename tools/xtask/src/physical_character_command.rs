...
pub(super) fn run() -> Result<(), String> {
    ...
    CommandReportV1::emit(
        ...
        PhysicalCharacterConformanceDetailsV1 {
            ...
            functional_anatomy_subjects: report.functional_anatomy_subjects,
            body_condition_transitions: report.body_condition_transitions,
            intact_knee_effort_micronewton_metres: report.intact_knee_effort_micronewton_metres,
            partial_knee_effort_micronewton_metres: report.partial_knee_effort_micronewton_metres,
            zero_knee_effort_micronewton_metres: report.zero_knee_effort_micronewton_metres,
            recovered_knee_effort_micronewton_metres: report
                .recovered_knee_effort_micronewton_metres,
            body_condition_matrix_digest: report.body_condition_matrix_digest.to_hex(),
