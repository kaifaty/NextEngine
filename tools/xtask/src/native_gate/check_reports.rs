...
use crate::report::{
    CommandReportV1, CommandReportV2, CommandReportV3, ContentPackageDetailsV1, HostCheckDetailsV1,
    PackageDetailsV1, PackageDetailsV3, PerformanceDetailsV1, PersistenceReplayDetailsV1,
...
pub(super) use linux::{validate_linux_check_reports, validate_linux_target_report_json_shape};
...
enum ValidatedCheckReportV1 {
    ...
    V1PackageV3(Box<CommandReportV3<PackageDetailsV3>>),
}
    ...
    match check {
        ...
        NativeGateCheckNameV1::Performance => {
            ...
            let run = report
                ...
                .run
                .as_ref()
                .ok_or_else(|| report_invalid("performance V6 run is missing"))?;
...
fn validate_native_performance_environment(
    run: &crate::performance::PerformanceRunV6,
    expected_target: &str,
) -> Result<(), NativeGateComparisonError> {
