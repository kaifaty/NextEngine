...
class WavlmRussianResdAdapterTests(unittest.TestCase):
    ...
    def test_generic_wav2vec2_head_uses_its_explicit_profile_map(self) -> None:
        label_map = {
            "Angry": "angry",
            "Disgusted": "disgusted",
            "Happy": "happy",
        ...
        labels = _validate_config(config, label_map, GENERIC_AUDIO_MODEL_TYPES)
        ...
        self.assertEqual(adapter.capabilities().adapter_id, GENERIC_AUDIO_ADAPTER_ID)
